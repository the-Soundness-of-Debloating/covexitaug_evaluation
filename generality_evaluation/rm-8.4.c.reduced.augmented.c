...
size_t freadahead(FILE *fp) {
  long tmp;
  {
    if ((unsigned long)fp->_IO_write_ptr > (unsigned long)fp->_IO_write_base) {
       printf("<This branch (L319) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (fp->_flags & 256) {
       printf("<This branch (L322) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      tmp = 0L;
    }
    ...
    if ((st->st_mode & 61440U) == 32768U) {
      if (st->st_size == 0L) {
        ...
        tmp___1 = tmp;
         ...
         printf("<This branch (L379) is removed by Cov debloating tool>\n"); exit(6);
      }
      return ((char const *)tmp___1);
    }
     printf("<This branch (L383) is removed by Cov debloating tool>\n"); exit(6);
  ...
  int *tmp___1;
  {
    if (0 <= fd) {
      if (fd <= 2) {
         ...
         printf("<This branch (L479) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    return (fd);
  }
...
int rpl_fcntl(int fd, int action, ...) {
  ...
  void *tmp___5;
  {
    ...
    if (action == 1030) {
       printf("<This branch (L508) is removed by Cov debloating tool>\n"); exit(6);
    }
    goto switch_default;
  case_1030:;
...
_Bool cycle_check(struct cycle_check_state *state, struct stat const *sb) {
  _Bool tmp;
  {
    if (!(state->magic == 9827862)) {
           ...
           printf("<This branch (L981) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (state->chdir_counter) {
       ...
       printf("<This branch (L988) is removed by Cov debloating tool>\n"); exit(6);
    }
    (state->chdir_counter)++;
    tmp = is_zero_or_power_of_two(state->chdir_counter);
    if (tmp) {
      if (state->chdir_counter == 0UL) {
         printf("<This branch (L994) is removed by Cov debloating tool>\n"); exit(6);
      }
...
void close_stdout(void) {
  ...
  int tmp___5;
  {
    ...
    if (tmp___5 != 0) {
       printf("<This branch (L1046) is removed by Cov debloating tool>\n"); exit(6);
    }
    return;
  }
}
...
void close_stdin(void) {
  ...
  int *tmp___6;
  {
    ...
    if (tmp___1 > 0UL) {
       ...
       printf("<This branch (L1074) is removed by Cov debloating tool>\n"); exit(6);
    }
    tmp___2 = close_stream(stdin);
    if (tmp___2 != 0) {
       printf("<This branch (L1078) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (fail) {
    ...
    close_stdout();
    if (fail) {
       printf("<This branch (L1094) is removed by Cov debloating tool>\n"); exit(6);
    }
    return;
  }
}
...
int close_stream(FILE *stream) {
  ...
  int *tmp___3;
  {
    ...
    if (prev_fail) {
       printf("<This branch (L1118) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      if (fclose_fail) {
         ...
         printf("<This branch (L1133) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    return (0);
  }
    ...
    if (0 <= flags) {
      if (value) {
        tmp___0 = flags | 1;
         ...
         printf("<This branch (L1153) is removed by Cov debloating tool>\n"); exit(6);
      }
      newflags = tmp___0;
      if (flags == newflags) {
     ...
     printf("<This branch (L1165) is removed by Cov debloating tool>\n"); exit(6);
  }
}
extern __attribute__((__nothrow__)) int(__attribute__((__leaf__))
                                        fchdir)(int __fd);
  ...
  _Bool saw_slash;
  {
    ...
    while (1) {
      if (!((int const) * base == 47)) {
       ...
       printf("<This branch (L1194) is removed by Cov debloating tool>\n"); exit(6);
    }
  while_break:;
    p = base;
    while (1) {
      ...
      if ((int const) * p == 47) {
         printf("<This branch (L1203) is removed by Cov debloating tool>\n"); exit(6);
      } else {
        if (saw_slash) {
    ...
    while (1) {
      if (1UL < len) {
        if (!((int const) * (name + (len - 1UL)) == 47)) {
         ...
         printf("<This branch (L1228) is removed by Cov debloating tool>\n"); exit(6);
      }
       printf("<This branch (L1230) is removed by Cov debloating tool>\n"); exit(6);
    __Cont:;
...
_Bool yesno(void) {
  ...
  int tmp___0;
  {
    ...
    response_len = tmp;
    if (response_len <= 0L) {
       printf("<This branch (L1417) is removed by Cov debloating tool>\n"); exit(6);
    } else {
...
void xalloc_die(void) {
   ...
   printf("<This branch (L1508) is removed by Cov debloating tool>\n"); exit(6);
}
...
struct dev_ino *get_root_dev_ino(struct dev_ino *root_d_i) {
  ...
  int tmp;
  {
    tmp = lstat("/", &statbuf);
    if (tmp) {
       printf("<This branch (L1755) is removed by Cov debloating tool>\n"); exit(6);
    }
  ...
  char const *tmp;
  {
    ...
    if ((unsigned long)translation == (unsigned long)msgid) {
      if ((unsigned int)s == 7U) {
         printf("<This branch (L1834) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    return (translation);
  }
...
quotearg_buffer_restyled(char *buffer, size_t buffersize, char const *arg,
  ...
  size_t tmp___7;
  {
    ...
    if ((unsigned int)quoting_style == 4U) {
       printf("<This branch (L1880) is removed by Cov debloating tool>\n"); exit(6);
    }
    if ((unsigned int)quoting_style == 3U) {
       printf("<This branch (L1883) is removed by Cov debloating tool>\n"); exit(6);
    }
    if ((unsigned int)quoting_style == 5U) {
       printf("<This branch (L1886) is removed by Cov debloating tool>\n"); exit(6);
    }
    if ((unsigned int)quoting_style == 6U) {
      goto case_6;
    }
     printf("<This branch (L1891) is removed by Cov debloating tool>\n"); exit(6);
  ...
  switch_break:;
    ...
    while (1) {
      ...
      if ((int)c == 0) {
         printf("<This branch (L2006) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 63) {
         printf("<This branch (L2009) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 7) {
         printf("<This branch (L2012) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 8) {
         printf("<This branch (L2015) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 12) {
         printf("<This branch (L2018) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 10) {
         printf("<This branch (L2021) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 13) {
         printf("<This branch (L2024) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 9) {
         printf("<This branch (L2027) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 11) {
         printf("<This branch (L2030) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 92) {
         printf("<This branch (L2033) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 123) {
         printf("<This branch (L2036) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 125) {
         printf("<This branch (L2039) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 35) {
         printf("<This branch (L2042) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 126) {
         printf("<This branch (L2045) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 32) {
         printf("<This branch (L2048) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 33) {
         printf("<This branch (L2051) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 34) {
         printf("<This branch (L2054) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 36) {
         printf("<This branch (L2057) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 38) {
         printf("<This branch (L2060) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 40) {
         printf("<This branch (L2063) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 41) {
         printf("<This branch (L2066) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 42) {
         printf("<This branch (L2069) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 59) {
         printf("<This branch (L2072) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 60) {
         printf("<This branch (L2075) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 61) {
         printf("<This branch (L2078) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 62) {
         printf("<This branch (L2081) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 91) {
         printf("<This branch (L2084) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 94) {
         printf("<This branch (L2087) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 96) {
         printf("<This branch (L2090) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 124) {
         printf("<This branch (L2093) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 39) {
         printf("<This branch (L2096) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 37) {
         printf("<This branch (L2099) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 43) {
         printf("<This branch (L2102) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 44) {
         printf("<This branch (L2105) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 45) {
         printf("<This branch (L2108) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 46) {
         printf("<This branch (L2111) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 47) {
         printf("<This branch (L2114) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 48) {
         printf("<This branch (L2117) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 49) {
         printf("<This branch (L2120) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 50) {
         printf("<This branch (L2123) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 51) {
         printf("<This branch (L2126) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 52) {
         printf("<This branch (L2129) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 53) {
         printf("<This branch (L2132) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 54) {
         printf("<This branch (L2135) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 55) {
         printf("<This branch (L2138) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 56) {
         printf("<This branch (L2141) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 57) {
         printf("<This branch (L2144) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 58) {
         printf("<This branch (L2147) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 65) {
         printf("<This branch (L2150) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 66) {
         printf("<This branch (L2153) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 67) {
         printf("<This branch (L2156) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 68) {
         printf("<This branch (L2159) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 69) {
         printf("<This branch (L2162) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 70) {
         printf("<This branch (L2165) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 71) {
         printf("<This branch (L2168) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 72) {
         printf("<This branch (L2171) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 73) {
         printf("<This branch (L2174) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 74) {
         printf("<This branch (L2177) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 75) {
         printf("<This branch (L2180) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 76) {
         printf("<This branch (L2183) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 77) {
         printf("<This branch (L2186) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 78) {
         printf("<This branch (L2189) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 79) {
         printf("<This branch (L2192) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 80) {
         printf("<This branch (L2195) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 81) {
         printf("<This branch (L2198) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 82) {
         printf("<This branch (L2201) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 83) {
         printf("<This branch (L2204) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 84) {
         printf("<This branch (L2207) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 85) {
         printf("<This branch (L2210) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 86) {
         printf("<This branch (L2213) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 87) {
         printf("<This branch (L2216) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 88) {
         printf("<This branch (L2219) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 89) {
         printf("<This branch (L2222) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 90) {
         printf("<This branch (L2225) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 93) {
         printf("<This branch (L2228) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 95) {
         printf("<This branch (L2231) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 97) {
         printf("<This branch (L2234) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 98) {
         printf("<This branch (L2237) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 99) {
         printf("<This branch (L2240) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 100) {
        goto case_37;
      }
      ...
      if ((int)c == 103) {
         printf("<This branch (L2252) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 104) {
      ...
      if ((int)c == 109) {
         printf("<This branch (L2270) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 110) {
         printf("<This branch (L2273) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 111) {
         printf("<This branch (L2276) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 112) {
         printf("<This branch (L2279) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 113) {
         printf("<This branch (L2282) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)c == 114) {
        goto case_37;
      }
        ...
        _L___3:;
          if (quote_these_too) {
            if (!(*(quote_these_too + (unsigned long)c / (sizeof(int) * 8UL)) &
             ...
             printf("<This branch (L2716) is removed by Cov debloating tool>\n"); exit(6);
          }
        } else {
        _L___2:;
          if (!is_right_quote) {
  ...
  while_break___3:;
    if (len == 0UL) {
       ...
       printf("<This branch (L2755) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (quote_string) {
      if (!elide_outer_quotes) {
        while (1) {
...
static char *quotearg_n_options(int n, char const *arg, size_t argsize,
  ...
  int *tmp___3;
  {
    ...
    sv = slotvec;
    if (n < 0) {
       printf("<This branch (L2813) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (nslots <= n0) {
    ...
    if (size <= qsize) {
                                ...
                                printf("<This branch (L2859) is removed by Cov debloating tool>\n"); exit(6);
    }
...
void set_program_name(char const *argv0) {
  ...
  int tmp___0;
  {
    if ((unsigned long)argv0 == (unsigned long)((void *)0)) {
       ...
       printf("<This branch (L2931) is removed by Cov debloating tool>\n"); exit(6);
    }
    slash = (char const *)strrchr(argv0, '/');
    if ((unsigned long)slash != (unsigned long)((void *)0)) {
      base = slash + 1;
    } else {
       printf("<This branch (L2937) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (base - argv0 >= 7L) {
...
int openat_safer(int fd, char const *file, int flags, ...) {
  ...
  int tmp___0;
  {
    ...
    if (flags & 64) {
       ...
       printf("<This branch (L3007) is removed by Cov debloating tool>\n"); exit(6);
    }
...
int i_ring_pop(I_ring *ir) {
  ...
  _Bool tmp;
  {
    ...
    if (tmp) {
       printf("<This branch (L3291) is removed by Cov debloating tool>\n"); exit(6);
    }
...
static _Bool setup_dir(FTS *fts) {
  {
    if (fts->fts_options & 258) {
       ...
       printf("<This branch (L4054) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      fts->fts_cycle.state =
          (struct cycle_check_state *)malloc(sizeof(*(fts->fts_cycle.state)));
      if (!fts->fts_cycle.state) {
         printf("<This branch (L4059) is removed by Cov debloating tool>\n"); exit(6);
      }
...
static void leave_dir(FTS *fts, FTSENT *ent) {
  ...
  FTSENT *parent;
  {
    ...
    if (fts->fts_options & 258) {
       ...
       printf("<This branch (L4118) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      ...
      if ((unsigned long)parent != (unsigned long)((void *)0)) {
        if (0L <= parent->fts_level) {
         ...
         printf("<This branch (L4137) is removed by Cov debloating tool>\n"); exit(6);
        }
      }
    }
    return;
...
static void free_dir(FTS *sp) {
  {
    if (sp->fts_options & 258) {
       ...
       printf("<This branch (L4149) is removed by Cov debloating tool>\n"); exit(6);
    } else {
...
__inline static DIR *opendirat(int fd, char const *dir) {
  ...
  int *tmp___1;
  {
    ...
    new_fd = tmp;
    if (new_fd < 0) {
       printf("<This branch (L4204) is removed by Cov debloating tool>\n"); exit(6);
    }
    ...
    if ((unsigned long)dirp == (unsigned long)((void *)0)) {
       ...
       printf("<This branch (L4213) is removed by Cov debloating tool>\n"); exit(6);
    }
    return (dirp);
  }
}
static void cwd_advance_fd(FTS *sp, int fd, _Bool chdir_down_one) {
  ...
  int tmp;
  {
    ...
    while (1) {
      if (!(old != fd)) {
        if (!(old == -100)) {
           printf("<This branch (L4227) is removed by Cov debloating tool>\n"); exit(6);
        }
      }
      goto while_break;
    }
  while_break:;
    if (chdir_down_one) {
      ...
      if (0 <= prev_fd_in_slot) {
         printf("<This branch (L4237) is removed by Cov debloating tool>\n"); exit(6);
      }
    } else {
       ...
       printf("<This branch (L4244) is removed by Cov debloating tool>\n"); exit(6);
    }
    sp->fts_cwd_fd = fd;
    return;
  }
...
FTS *(__attribute__((__warn_unused_result__, __leaf__))
  ...
  int tmp___11;
  {
    ...
    if (options & 4) {
       ...
       printf("<This branch (L4318) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (!(options & 18)) {


       printf("<This branch (L4323) is removed by Cov debloating tool>\n"); exit(6);
    }
    sp = (FTS *)malloc(sizeof(FTS));
    if ((unsigned long)sp == (unsigned long)((void *)0)) {
       printf("<This branch (L4327) is removed by Cov debloating tool>\n"); exit(6);
    }
    ...
    if (sp->fts_options & 2) {
       ...
       printf("<This branch (L4334) is removed by Cov debloating tool>\n"); exit(6);
    }
    sp->fts_cwd_fd = -100;
    tmp___4 = fts_maxarglen(argv);
    maxarglen = tmp___4;
    if (maxarglen > 4096UL) {
       printf("<This branch (L4340) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      tmp___5 = (size_t)4096;
    }
    tmp___6 = fts_palloc(sp, tmp___5);
    if (!tmp___6) {
       printf("<This branch (L4346) is removed by Cov debloating tool>\n"); exit(6);
    }
    if ((unsigned long)*argv != (unsigned long)((void *)0)) {
      parent = fts_alloc(sp, "", (size_t)0);
      if ((unsigned long)parent == (unsigned long)((void *)0)) {
         printf("<This branch (L4351) is removed by Cov debloating tool>\n"); exit(6);
      }
    ...
    if ((unsigned long)compar == (unsigned long)((void *)0)) {
      tmp___7 = 1;
       ...
       printf("<This branch (L4362) is removed by Cov debloating tool>\n"); exit(6);
    }
    ...
    while (1) {
      ...
      if ((unsigned long)p == (unsigned long)((void *)0)) {
         printf("<This branch (L4375) is removed by Cov debloating tool>\n"); exit(6);
      }
      ...
      if (defer_stat) {
        if ((unsigned long)root != (unsigned long)((void *)0)) {
           ...
           printf("<This branch (L4383) is removed by Cov debloating tool>\n"); exit(6);
        } else {
          p->fts_info = fts_stat(sp, p, (_Bool)0);
        }
      } else {
         printf("<This branch (L4388) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (compar) {

         printf("<This branch (L4392) is removed by Cov debloating tool>\n"); exit(6);
      } else {
        ...
        if ((unsigned long)root == (unsigned long)((void *)0)) {
          ...
          tmp = root;
           ...
           printf("<This branch (L4400) is removed by Cov debloating tool>\n"); exit(6);
        }
      }
      argv++;
      nitems++;
  ...
  while_break:;
    if (compar) {
       ...
       printf("<This branch (L4410) is removed by Cov debloating tool>\n"); exit(6);
    }
    tmp___9 = fts_alloc(sp, "", (size_t)0);
    sp->fts_cur = tmp___9;
    if ((unsigned long)tmp___9 == (unsigned long)((void *)0)) {
       printf("<This branch (L4415) is removed by Cov debloating tool>\n"); exit(6);
    }
    (sp->fts_cur)->fts_link = root;
    (sp->fts_cur)->fts_info = (unsigned short)9;
    tmp___10 = setup_dir(sp);
    if (!tmp___10) {
       printf("<This branch (L4421) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (!(sp->fts_options & 4)) {
      if (!(sp->fts_options & 512)) {
         ...
         printf("<This branch (L4429) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
...
int(__attribute__((__warn_unused_result__, __leaf__)) fts_close)(FTS *sp) {
  ...
  int *tmp___5;
  {
    ...
    while_break:;
       printf("<This branch (L4506) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (sp->fts_child) {
    ...
    if (sp->fts_leaf_optimization_works_ht) {
       printf("<This branch (L4539) is removed by Cov debloating tool>\n"); exit(6);
    }
    free_dir(sp);
    free((void *)sp);
    if (saved_errno) {
       ...
       printf("<This branch (L4546) is removed by Cov debloating tool>\n"); exit(6);
    }
    return (0);
  }
}
...
FTSENT *(__attribute__((__warn_unused_result__, __leaf__)) fts_read)(FTS *sp) {
  ...
  FTSENT *tmp___32;
  {
    if ((unsigned long)sp->fts_cur == (unsigned long)((void *)0)) {
       printf("<This branch (L4708) is removed by Cov debloating tool>\n"); exit(6);
    } else {
    ...
    if ((int)instr == 2) {
       ...
       printf("<This branch (L4743) is removed by Cov debloating tool>\n"); exit(6);
    }
    if ((int)p->fts_info == 1) {
      if ((int)instr == 4) {
        goto _L___0;
        ...
        if (sp->fts_options & 64) {
          ...
          _L___0:;
            ...
            if (sp->fts_child) {
               ...
               printf("<This branch (L4757) is removed by Cov debloating tool>\n"); exit(6);
            }
      ...
      if ((unsigned long)sp->fts_child != (unsigned long)((void *)0)) {
         ...
         printf("<This branch (L4774) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((unsigned long)sp->fts_child != (unsigned long)((void *)0)) {
         ...
         printf("<This branch (L4791) is removed by Cov debloating tool>\n"); exit(6);
      } else {
       ...
       printf("<This branch (L4812) is removed by Cov debloating tool>\n"); exit(6);
  ...
  next:;
    ...
    if ((unsigned long)p != (unsigned long)((void *)0)) {
      ...
      if (p->fts_level == 0L) {
          ...
          if (sp->fts_options & 512) {
            if (sp->fts_options & 512) {
              tmp___5 = -100;
               ...
               printf("<This branch (L4829) is removed by Cov debloating tool>\n"); exit(6);
            }
            ...
            tmp___8 = 0;
             ...
             printf("<This branch (L4840) is removed by Cov debloating tool>\n"); exit(6);
          }
          if (tmp___8) {
        ...
        if (tmp___9) {
           ...
           printf("<This branch (L4852) is removed by Cov debloating tool>\n"); exit(6);
        }
        free_dir(sp);
        fts_load(sp, p);
        setup_dir(sp);
       ...
       printf("<This branch (L4859) is removed by Cov debloating tool>\n"); exit(6);
    ...
    check_for_dir:;
      ...
      if ((int)p->fts_info == 11) {
         ...
         printf("<This branch (L4932) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int)p->fts_info == 1) {
        if (p->fts_level == 0L) {
        ...
        if (!tmp___16) {
           ...
           printf("<This branch (L4942) is removed by Cov debloating tool>\n"); exit(6);
        }
      }
      return (p);
    }
    ...
    if (p->fts_level == -1L) {
     ...
     printf("<This branch (L4958) is removed by Cov debloating tool>\n"); exit(6);
        ...
        if (instr != 2) {
          if (instr != 3) {
            if (instr != 4) {
               ...
               printf("<This branch (L5066) is removed by Cov debloating tool>\n"); exit(6);
            }
          }
        }
      }
...
static FTSENT *fts_build(FTS *sp, int type) {
  ...
  _Bool tmp___27;
  {
    ...
    if (!(sp->fts_options & 4)) {
      if (sp->fts_options & 512) {
        ...
        dirp = tmp___0;
         ...
         printf("<This branch (L5205) is removed by Cov debloating tool>\n"); exit(6);
      }
    } else {

       printf("<This branch (L5209) is removed by Cov debloating tool>\n"); exit(6);
    }
    if ((unsigned long)dirp == (unsigned long)((void *)0)) {
       ...
       printf("<This branch (L5217) is removed by Cov debloating tool>\n"); exit(6);
    }
    if ((int)cur->fts_info == 11) {
       printf("<This branch (L5220) is removed by Cov debloating tool>\n"); exit(6);
    } else {
    ...
    if (type == 2) {
       ...
       printf("<This branch (L5239) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      if (sp->fts_options & 8) {
        if (sp->fts_options & 16) {
          ...
          nostat = (_Bool)1;
           ...
           printf("<This branch (L5252) is removed by Cov debloating tool>\n"); exit(6);
        }
      } else {

         printf("<This branch (L5256) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    if (nlinks) {
      ...
      _L___0:;
        ...
        if (dir_fd < 0) {
           printf("<This branch (L5273) is removed by Cov debloating tool>\n"); exit(6);
        } else {
          tmp___7 =
         ...
         printf("<This branch (L5299) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    if ((int)*(cur->fts_path + (cur->fts_pathlen - 1UL)) == 47) {
       printf("<This branch (L5303) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      len = cur->fts_pathlen;
    }
    if (sp->fts_options & 4) {
       ...
       printf("<This branch (L5311) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      cp = (char *)((void *)0);
    }
    len++;
    ...
    while (1) {
      if (dirp) {
        ...
        if (!dp) {
         ...
         printf("<This branch (L5329) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (!(sp->fts_options & 32)) {
       ...
       printf("<This branch (L5344) is removed by Cov debloating tool>\n"); exit(6);
  ...
  while_break___0:;
    ...
    if (doadjust) {
       printf("<This branch (L5472) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (sp->fts_options & 4) {
    ...
    if (descend) {
      if (type == 1) {
         printf("<This branch (L5486) is removed by Cov debloating tool>\n"); exit(6);
      } else {
        if (!nitems) {
        _L___2:;
          if (cur->fts_level == 0L) {
            ...
            if (!(sp->fts_options & 4)) {
              if (sp->fts_options & 512) {
                if (sp->fts_options & 512) {
                  tmp___20 = -100;
                   ...
                   printf("<This branch (L5497) is removed by Cov debloating tool>\n"); exit(6);
                }
              ...
              if (tmp___23) {
               ...
               printf("<This branch (L5516) is removed by Cov debloating tool>\n"); exit(6);
            }
            tmp___26 = tmp___24;
          } else {

             printf("<This branch (L5521) is removed by Cov debloating tool>\n"); exit(6);
          }
          if (tmp___26) {
    ...
    if (!nitems) {
     ...
     printf("<This branch (L5539) is removed by Cov debloating tool>\n"); exit(6);
...
static unsigned short fts_stat(FTS *sp, FTSENT *p, _Bool follow) {
  ...
  int tmp___7;
  {
    ...
    if (p->fts_level == 0L) {
      if (sp->fts_options & 1) {
         printf("<This branch (L5575) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    if (sp->fts_options & 2) {
       printf("<This branch (L5579) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      if (follow) {
      _L:;
    ...
    if ((sbp->st_mode & 61440U) == 16384U) {
      if (sp->fts_options & 32) {
         printf("<This branch (L5613) is removed by Cov debloating tool>\n"); exit(6);
      } else {
        tmp___6 = 2;
      }
      ...
      if ((int)p->fts_name[0] == 46) {
         ...
         printf("<This branch (L5633) is removed by Cov debloating tool>\n"); exit(6);
      }
    ...
    if ((sbp->st_mode & 61440U) == 32768U) {
     ...
     printf("<This branch (L5643) is removed by Cov debloating tool>\n"); exit(6);
  }
}
...
static FTSENT *fts_alloc(FTS *sp, char const *name, size_t namelen) {
  ...
  size_t len;
  {
    ...
    p = (FTSENT *)malloc(len);
    if ((unsigned long)p == (unsigned long)((void *)0)) {
       printf("<This branch (L5730) is removed by Cov debloating tool>\n"); exit(6);
    }
  ...
  register FTSENT *p;
  {
    while (1) {
      ...
      if (!p) {
       ...
       printf("<This branch (L5753) is removed by Cov debloating tool>\n"); exit(6);
...
static _Bool fts_palloc(FTS *sp, size_t more) {
  ...
  int *tmp;
  {
    ...
    if (new_len < sp->fts_pathlen) {
       ...
       printf("<This branch (L5771) is removed by Cov debloating tool>\n"); exit(6);
    }
    ...
    if ((unsigned long)p == (unsigned long)((void *)0)) {
       ...
       printf("<This branch (L5778) is removed by Cov debloating tool>\n"); exit(6);
    }
    sp->fts_path = p;
    return ((_Bool)1);
  }
...
static int fts_safe_changedir(FTS *sp, FTSENT *p, int fd, char const *dir) {
  ...
  int *tmp___6;
  {
    if (dir) {
       ...
       printf("<This branch (L5869) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      tmp___0 = 0;
    }
    ...
    if (sp->fts_options & 4) {
       ...
       printf("<This branch (L5880) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (fd < 0) {
       ...
       printf("<This branch (L5895) is removed by Cov debloating tool>\n"); exit(6);
    }
    newfd = fd;
    if (fd < 0) {
       ...
       printf("<This branch (L5902) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (sp->fts_options & 2) {
      ...
      if (dir) {
         ...
         printf("<This branch (L5929) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    if (sp->fts_options & 512) {
...
__inline static _Bool dot_or_dotdot(char const *file_name___3) {
  ...
  int tmp;
  {
    if ((int const) * (file_name___3 + 0) == 46) {
       ...
       printf("<This branch (L6056) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      return ((_Bool)0);
    }
  }
  ...
  int *tmp___1;
  {
    if (st->st_size == -1L) {
      ...
      if (tmp___0 != 0) {
         ...
         printf("<This branch (L6131) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    if (0L <= st->st_size) {
      return (0);
...
static int write_protected_non_symlink(int fd_cwd, char const *file,
  ...
  int *tmp___7;
  {
    ...
    if (tmp) {
     ...
     printf("<This branch (L6166) is removed by Cov debloating tool>\n"); exit(6);
...
static enum RM_status prompt(FTS const *fts, FTSENT const *ent, _Bool is_dir,
  ...
  _Bool tmp___15;
  {
    ...
    write_protected = 0;
    if (ent->fts_number) {
       printf("<This branch (L6248) is removed by Cov debloating tool>\n"); exit(6);
    }
    ...
    if (write_protected) {
      ...
      _L___2:;
          ...
          if (dirent_type == 0) {
            ...
            if (tmp___2 == 0) {
              if ((sbuf->st_mode & 61440U) == 40960U) {
                 printf("<This branch (L6279) is removed by Cov debloating tool>\n"); exit(6);
              } else {
               ...
               printf("<This branch (L6288) is removed by Cov debloating tool>\n"); exit(6);
            }
          }
        }
        if (0 <= write_protected) {
        ...
        if (write_protected < 0) {
           ...
           printf("<This branch (L6318) is removed by Cov debloating tool>\n"); exit(6);
        }
        if (is_empty_p) {
        ...
        if (dirent_type == 4) {
           ...
           printf("<This branch (L6347) is removed by Cov debloating tool>\n"); exit(6);
        } else {
        _L___1:;
          ...
          if (tmp___10 != 0) {
             ...
             printf("<This branch (L6355) is removed by Cov debloating tool>\n"); exit(6);
          }
  ...
  FTSENT *p;
  {
    ...
    while (1) {
      if (!(0L <= p->fts_level)) {
       ...
       printf("<This branch (L6426) is removed by Cov debloating tool>\n"); exit(6);
...
static enum RM_status excise(FTS *fts, FTSENT *ent, struct rm_options const *x,
  ...
  int *tmp___14;
  {
    ...
    if (*tmp___8 == 30) {
       ...
       printf("<This branch (L6490) is removed by Cov debloating tool>\n"); exit(6);
    }
    tmp___9 = __errno_location();
    tmp___10 = ignorable_missing(x, *tmp___9);
    if (tmp___10) {
       printf("<This branch (L6495) is removed by Cov debloating tool>\n"); exit(6);
    }
    if ((int)ent->fts_info == 4) {

       printf("<This branch (L6499) is removed by Cov debloating tool>\n"); exit(6);
    }
...
static enum RM_status rm_fts(FTS *fts, FTSENT *ent,
  ...
  char *tmp___24;
  {
    ...
    if ((int)ent->fts_info == 12) {
       printf("<This branch (L6552) is removed by Cov debloating tool>\n"); exit(6);
    }
    if ((int)ent->fts_info == 13) {
       printf("<This branch (L6555) is removed by Cov debloating tool>\n"); exit(6);
    }
  ...
  case_8:;
    if ((int)ent->fts_info == 6) {
      if (x->one_file_system) {
         ...
         printf("<This branch (L6654) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    if ((int)ent->fts_info == 6) {
      tmp___16 = 1;
      ...
      if ((int)ent->fts_info == 4) {
         printf("<This branch (L6661) is removed by Cov debloating tool>\n"); exit(6);
      } else {
        tmp___16 = 0;
      }
    }
...
enum RM_status rm(char *const *file, struct rm_options const *x) {
  ...
  int tmp___6;
  {
    ...
    if (*file) {
      bit_flags = 536;
      if (x->one_file_system) {
         printf("<This branch (L6723) is removed by Cov debloating tool>\n"); exit(6);
      }
        ...
        if (!((unsigned int)s == 2U)) {
          if (!((unsigned int)s == 3U)) {
            if (!((unsigned int)s == 4U)) {
                   ...
                   printf("<This branch (L6749) is removed by Cov debloating tool>\n"); exit(6);
            }
          }
        }
        while (1) {
    ...
    while_break:;
      ...
      if (tmp___6 != 0) {
         ...
         printf("<This branch (L6773) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    return (rm_status);
  }
...
void usage(int status) {
   ...
   printf("<This branch (L6950) is removed by Cov debloating tool>\n"); exit(6);
}
...
int main(int argc, char **argv) {
  ...
  int tmp___9;
  {
    ...
    while (1) {
      ...
      if (c == 100) {
         printf("<This branch (L7003) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (c == 102) {
        goto case_102;
      }
      ...
      if (c == 73) {
         printf("<This branch (L7012) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (c == 114) {
        goto case_114;
      }
       printf("<This branch (L7017) is removed by Cov debloating tool>\n"); exit(6);
  ...
  while_break:;
    if (argc <= optind) {
       ...
       printf("<This branch (L7138) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (x.recursive) {
      if (preserve_root) {
        ...
        if ((unsigned long)x.root_dev_ino == (unsigned long)((void *)0)) {
           ...
           printf("<This branch (L7147) is removed by Cov debloating tool>\n"); exit(6);
        }
      }
    }
    ...
    if (prompt_once) {
       ...
       printf("<This branch (L7172) is removed by Cov debloating tool>\n"); exit(6);
    }
    ...
    if (!((unsigned int)status == 2U)) {
      if (!((unsigned int)status == 3U)) {
        if (!((unsigned int)status == 4U)) {
                         ...
                         printf("<This branch (L7182) is removed by Cov debloating tool>\n"); exit(6);
        }
      }
    }
    if ((unsigned int)status == 4U) {

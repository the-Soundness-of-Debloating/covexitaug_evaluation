...
void close_stdout(void) {
  ...
  char *__cil_tmp10;
  {
    ...
    if (tmp___3 != 0) {
       ...
       printf("<This branch (L1347) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
    ...
    if (tmp___5 != 0) {
      ...
      } printf("<This branch (L1355) is removed by Cov debloating tool>\n"); exit(6);
    }
    return;
  }
}
...
int close_stream(FILE *stream) {
  ...
  int *tmp___3;
  {
    ...
    if (prev_fail) {
       printf("<This branch (L1386) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      if (fclose_fail) {
         ...
         printf("<This branch (L1405) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    return (0);
  }
...
extern __attribute__((__nothrow__)) __locale_t____(__attribute__((__leaf__)) newlocale)(int __category_mask,
                                                                                    char const *__locale,
                                                                                    __locale_t____ __base);
  ...
  char *tmp___6;
  {
    ...
    if (0 <= strtol_base) {
      if (!(strtol_base <= 36)) {
        ...
        } printf("<This branch (L1952) is removed by Cov debloating tool>\n"); exit(6);
      }
    } else {
      {


      } printf("<This branch (L1958) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (ptr) {
    ...
    ch = (unsigned char)*q;
    {
      ...
      while_continue: /* CIL Label */;
        ...
        if (!((int const) * (*tmp___0 + (int)ch) & 8192)) {
         ...
         printf("<This branch (L1976) is removed by Cov debloating tool>\n"); exit(6);

      }
    while_break: /* CIL Label */;
    }
    if ((int)ch == 45) {
       printf("<This branch (L1982) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
    ...
    if ((unsigned long)*p == (unsigned long)s) {
       ...
       printf("<This branch (L2005) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      {
...
void *xrealloc(void *p, size_t n) {
  {
    if (!n) {
       ...
       printf("<This branch (L2305) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
      p = realloc(p, n);
    }
    if (!p) {
       ...
       printf("<This branch (L2315) is removed by Cov debloating tool>\n"); exit(6);
    }
    return (p);
  }
}
        ...
        if (c == -1) {
          if ((unsigned long)p == (unsigned long)buffer) {
          ...
          } else {
            {
             ...
             printf("<This branch (L5891) is removed by Cov debloating tool>\n"); exit(6);
          }
           printf("<This branch (L5893) is removed by Cov debloating tool>\n"); exit(6);
      ...
      if (1) {
        ...
        if (tmp___0 == 0) {
        ...
        } else {
          {
           ...
           printf("<This branch (L5969) is removed by Cov debloating tool>\n"); exit(6);
        }
      } else {
        {
         ...
         printf("<This branch (L6006) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    return (hard);
  }
...
FILE *freopen_safer(char const *name, char const *mode, FILE *f) {
  ...
  int *tmp___7;
  {
    ...
    }
    {
      ...
      if (tmp == 1) {
         printf("<This branch (L6119) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (tmp == 0) {
        goto case_0;
      }
       printf("<This branch (L6124) is removed by Cov debloating tool>\n"); exit(6);
    switch_default : ;/* CIL Label */
    {
    ...
    if (protect_in) {
      {
       ...
       printf("<This branch (L6158) is removed by Cov debloating tool>\n"); exit(6);
    } else {
    _L___0:;
      if (protect_out) {
        {
         ...
         printf("<This branch (L6169) is removed by Cov debloating tool>\n"); exit(6);
      } else {
      _L:;
        if (protect_err) {
          {
    ...
    if (protect_err) {
      ...
      } printf("<This branch (L6199) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (protect_out) {
      {

      } printf("<This branch (L6204) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (protect_in) {
      {

      } printf("<This branch (L6209) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (!f) {
      {
...
__inline static void clear_ungetc_buffer_preserving_position(FILE *fp) {
  {
    if (fp->_flags & 256) {
      ...
      } printf("<This branch (L6230) is removed by Cov debloating tool>\n"); exit(6);
    }
    return;
  }
}
    ...
    if ((unsigned long)stream == (unsigned long)((void *)0)) {
      {
       ...
       printf("<This branch (L6244) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      {
...
int(__attribute__((__nonnull__(1))) rpl_fclose)(FILE *fp) {
  ...
  int *tmp___5;
  {
    ...
    if (fd < 0) {
      {
       ...
       printf("<This branch (L6287) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
    ...
    if (tmp___1 != 0) {
      ...
      _L : {
        ...
        if (tmp___4) {
          ...
          } printf("<This branch (L6305) is removed by Cov debloating tool>\n"); exit(6);
        }
      }
    } else {
      goto _L;
    ...
    if (saved_errno != 0) {
      ...
      } printf("<This branch (L6319) is removed by Cov debloating tool>\n"); exit(6);
    }
    return (result);
  }
}
...
static void check_file(char const *infile, char const *outfile, char delimiter) {
  ...
  char *__cil_tmp45;
  {
    ...
    if (!(tmp___0 == 0)) {
      ...
      if (!tmp___1) {
        ...
        } printf("<This branch (L6800) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    {
        ...
        if ((unsigned int)countmode == 1U) {
          {
            ...
            while_continue: /* CIL Label */;
              ...
              if (tmp___7) {
                 printf("<This branch (L6834) is removed by Cov debloating tool>\n"); exit(6);
              }
              {
    ...
    _L___2 : {
      ...
      }
      {
        ...
        while_continue___1: /* CIL Label */;
          ...
          if (tmp___14) {
             printf("<This branch (L6900) is removed by Cov debloating tool>\n"); exit(6);
          }
          {
          ...
          if ((unsigned long)tmp___10 == (unsigned long)((struct linebuffer *)0)) {
            ...
            if (tmp___9) {
               printf("<This branch (L6910) is removed by Cov debloating tool>\n"); exit(6);
            }
            goto while_break___1;
          }
          {
          ...
          if (match_count == 0xffffffffffffffffUL) {
             printf("<This branch (L6927) is removed by Cov debloating tool>\n"); exit(6);
          }
  ...
  closefiles : {
    ...
    if (tmp___16) {
      ...
      } printf("<This branch (L6990) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      {
...
int main(int argc, char **argv) {
  ...
  char *__cil_tmp36;
  {
    ...
    }
    {
      ...
      while_continue: /* CIL Label */;
        if (optc == -1) {
           printf("<This branch (L7073) is removed by Cov debloating tool>\n"); exit(6);
        } else {
          if (posixly_correct) {
             ...
             printf("<This branch (L7080) is removed by Cov debloating tool>\n"); exit(6);
          } else {
          _L___3 : {
            ...
            _L___2:;
            ...
            } else {
              {
                ...
                if (optc == 53) {
                   printf("<This branch (L7125) is removed by Cov debloating tool>\n"); exit(6);
                }
                if (optc == 54) {
                   printf("<This branch (L7128) is removed by Cov debloating tool>\n"); exit(6);
                }
                if (optc == 55) {
                   printf("<This branch (L7131) is removed by Cov debloating tool>\n"); exit(6);
                }
                if (optc == 56) {
                   printf("<This branch (L7134) is removed by Cov debloating tool>\n"); exit(6);
                }
                if (optc == 57) {
                ...
                if (optc == 68) {
                   printf("<This branch (L7146) is removed by Cov debloating tool>\n"); exit(6);
                }
                if (optc == 102) {
                  goto case_102;
                }

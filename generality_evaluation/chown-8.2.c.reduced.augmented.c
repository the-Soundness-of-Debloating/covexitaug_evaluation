...
DIR *rpl_fdopendir(int fd) {
  ...
  DIR *tmp___1;
  {
    tmp = fstat(fd, &st);
    if (tmp) {
       printf("<This branch (L374) is removed by Cov debloating tool>\n"); exit(6);
    }
  ...
  int *tmp___1;
  {
    if (0 <= fd) {
      if (fd <= 2) {
         ...
         printf("<This branch (L402) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    return (fd);
  }
...
_Bool cycle_check(struct cycle_check_state *state, struct stat const *sb) {
  _Bool tmp;
  {
    if (!(state->magic == 9827862)) {
                     ...
                     printf("<This branch (L685) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (state->chdir_counter) {
      if (sb->st_ino == (__ino_t const)state->dev_ino.st_ino) {


         printf("<This branch (L691) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    (state->chdir_counter)++;
    ...
    if (tmp) {
      if (state->chdir_counter == 0UL) {
         printf("<This branch (L698) is removed by Cov debloating tool>\n"); exit(6);
      }
...
void close_stdout(void) {
  ...
  int tmp___5;
  {
    ...
    if (tmp___3 != 0) {
       ...
       printf("<This branch (L746) is removed by Cov debloating tool>\n"); exit(6);
    }
    tmp___5 = close_stream(stderr);
    if (tmp___5 != 0) {
       printf("<This branch (L750) is removed by Cov debloating tool>\n"); exit(6);
    }
    return;
  }
}
...
int close_stream(FILE *stream) {
  ...
  int *tmp___3;
  {
    ...
    if (prev_fail) {
       printf("<This branch (L774) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      if (fclose_fail) {
         ...
         printf("<This branch (L789) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    return (0);
  }
    ...
    if (0 <= flags) {
      if (value) {
        tmp___0 = flags | 1;
         ...
         printf("<This branch (L809) is removed by Cov debloating tool>\n"); exit(6);
      }
      newflags = tmp___0;
      if (flags == newflags) {
         printf("<This branch (L813) is removed by Cov debloating tool>\n"); exit(6);
      } else {
     ...
     printf("<This branch (L821) is removed by Cov debloating tool>\n"); exit(6);
  }
}
extern __attribute__((__nothrow__)) int(__attribute__((__leaf__))
                                        fchdir)(int __fd);
...
FTS *xfts_open(char *const *argv, int options,
  ...
  int *tmp___0;
  {
    ...
    if ((unsigned long)fts == (unsigned long)((void *)0)) {
       ...
       printf("<This branch (L1232) is removed by Cov debloating tool>\n"); exit(6);
    }
    return (fts);
  }
}
...
void xalloc_die(void) {
   ...
   printf("<This branch (L1272) is removed by Cov debloating tool>\n"); exit(6);
}
  ...
  char const *tmp___9;
  {
    ...
    *username = tmp;
    ...
    if ((unsigned long)separator == (unsigned long)((void *)0)) {
       ...
       printf("<This branch (L1506) is removed by Cov debloating tool>\n"); exit(6);
    } else {
    ...
    if ((unsigned long)separator == (unsigned long)((void *)0)) {
       printf("<This branch (L1515) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      if ((int const) * (separator + 1) == 0) {
         printf("<This branch (L1518) is removed by Cov debloating tool>\n"); exit(6);
      } else {
        g = separator + 1;
      }
    }
    if ((unsigned long)u != (unsigned long)((void *)0)) {
      ...
      if ((unsigned long)pwd == (unsigned long)((void *)0)) {
         ...
         printf("<This branch (L1559) is removed by Cov debloating tool>\n"); exit(6);
      } else {
        unum = pwd->pw_uid;
    ...
    if ((unsigned long)g != (unsigned long)((void *)0)) {
      if ((unsigned long)error_msg == (unsigned long)((void *)0)) {
        if ((int const) * g == 43) {
           printf("<This branch (L1582) is removed by Cov debloating tool>\n"); exit(6);
        } else {
          tmp___6 = getgrnam(g);
          grp = tmp___6;
        }
...
char const *parse_user_spec(char const *spec, uid_t *uid, gid_t *gid,
  ...
  char const *tmp___2;
  {
    ...
    if (!colon) {
       ...
       printf("<This branch (L1648) is removed by Cov debloating tool>\n"); exit(6);
    }
    return (error_msg);
  }
}
...
void set_program_name(char const *argv0) {
  ...
  int tmp___0;
  {
    if ((unsigned long)argv0 == (unsigned long)((void *)0)) {
       ...
       printf("<This branch (L2874) is removed by Cov debloating tool>\n"); exit(6);
    }
    slash = (char const *)strrchr(argv0, '/');
    if ((unsigned long)slash != (unsigned long)((void *)0)) {
      base = slash + 1;
    } else {
       printf("<This branch (L2880) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (base - argv0 >= 7L) {
       ...
       printf("<This branch (L2891) is removed by Cov debloating tool>\n"); exit(6);
    }
    program_name = argv0;
...
int openat_safer(int fd, char const *file, int flags, ...) {
  ...
  int tmp___0;
  {
    ...
    if (flags & 64) {
       ...
       printf("<This branch (L2953) is removed by Cov debloating tool>\n"); exit(6);
    }
...
int i_ring_pop(I_ring *ir) {
  ...
  _Bool tmp;
  {
    ...
    if (tmp) {
       printf("<This branch (L3237) is removed by Cov debloating tool>\n"); exit(6);
    }
...
static _Bool setup_dir(FTS *fts) {
  {
    if (fts->fts_options & 258) {
      ...
      if (!fts->fts_cycle.state) {
         printf("<This branch (L4005) is removed by Cov debloating tool>\n"); exit(6);
      }
...
static _Bool enter_dir(FTS *fts, FTSENT *ent) {
  ...
  _Bool tmp___0;
  {
    if (fts->fts_options & 258) {
       ...
       printf("<This branch (L4038) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      tmp___0 = cycle_check(fts->fts_cycle.state,
                            (struct stat const *)(ent->fts_statp));
      if (tmp___0) {

         printf("<This branch (L4044) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    return ((_Bool)1);
  }
...
static void leave_dir(FTS *fts, FTSENT *ent) {
  ...
  FTSENT *parent;
  {
    ...
    if (fts->fts_options & 258) {
       ...
       printf("<This branch (L4064) is removed by Cov debloating tool>\n"); exit(6);
    } else {
...
static void free_dir(FTS *sp) {
  {
    if (sp->fts_options & 258) {
       ...
       printf("<This branch (L4095) is removed by Cov debloating tool>\n"); exit(6);
    } else {
...
__inline static DIR *opendirat(int fd, char const *dir) {
  ...
  int *tmp___1;
  {
    ...
    new_fd = tmp;
    if (new_fd < 0) {
       printf("<This branch (L4150) is removed by Cov debloating tool>\n"); exit(6);
    }
    ...
    if ((unsigned long)dirp == (unsigned long)((void *)0)) {
       ...
       printf("<This branch (L4159) is removed by Cov debloating tool>\n"); exit(6);
    }
    return (dirp);
  }
}
  ...
  while_break:;
    if (chdir_down_one) {
      ...
      if (0 <= prev_fd_in_slot) {
         printf("<This branch (L4183) is removed by Cov debloating tool>\n"); exit(6);
      }
    } else {
      if (!(sp->fts_options & 4)) {
        if (0 <= old) {
...
FTS *(__attribute__((__warn_unused_result__, __leaf__))
  ...
  int tmp___11;
  {
    ...
    if (options & -2048) {
       ...
       printf("<This branch (L4257) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (options & 4) {
    ...
    if (!(options & 18)) {
       ...
       printf("<This branch (L4269) is removed by Cov debloating tool>\n"); exit(6);
    }
    sp = (FTS *)malloc(sizeof(FTS));
    if ((unsigned long)sp == (unsigned long)((void *)0)) {
       printf("<This branch (L4273) is removed by Cov debloating tool>\n"); exit(6);
    }
    ...
    if (sp->fts_options & 2) {
       ...
       printf("<This branch (L4280) is removed by Cov debloating tool>\n"); exit(6);
    }
    sp->fts_cwd_fd = -100;
    tmp___4 = fts_maxarglen(argv);
    maxarglen = tmp___4;
    if (maxarglen > 4096UL) {
       printf("<This branch (L4286) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      tmp___5 = (size_t)4096;
    }
    tmp___6 = fts_palloc(sp, tmp___5);
    if (!tmp___6) {
       printf("<This branch (L4292) is removed by Cov debloating tool>\n"); exit(6);
    }
    if ((unsigned long)*argv != (unsigned long)((void *)0)) {
      parent = fts_alloc(sp, "", (size_t)0);
      if ((unsigned long)parent == (unsigned long)((void *)0)) {
         printf("<This branch (L4297) is removed by Cov debloating tool>\n"); exit(6);
      }
    ...
    if ((unsigned long)compar == (unsigned long)((void *)0)) {
      tmp___7 = 1;
       ...
       printf("<This branch (L4308) is removed by Cov debloating tool>\n"); exit(6);
    }
    ...
    while (1) {
      ...
      if ((unsigned long)p == (unsigned long)((void *)0)) {
         printf("<This branch (L4321) is removed by Cov debloating tool>\n"); exit(6);
      }
      ...
      if (compar) {
         ...
         printf("<This branch (L4338) is removed by Cov debloating tool>\n"); exit(6);
      } else {
  ...
  while_break:;
    if (compar) {
       ...
       printf("<This branch (L4356) is removed by Cov debloating tool>\n"); exit(6);
    }
    tmp___9 = fts_alloc(sp, "", (size_t)0);
    sp->fts_cur = tmp___9;
    if ((unsigned long)tmp___9 == (unsigned long)((void *)0)) {
       printf("<This branch (L4361) is removed by Cov debloating tool>\n"); exit(6);
    }
    (sp->fts_cur)->fts_link = root;
    (sp->fts_cur)->fts_info = (unsigned short)9;
    tmp___10 = setup_dir(sp);
    if (!tmp___10) {
       printf("<This branch (L4367) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (!(sp->fts_options & 4)) {
...
int(__attribute__((__warn_unused_result__, __leaf__)) fts_close)(FTS *sp) {
  ...
  int *tmp___5;
  {
    ...
    while_break:;
       printf("<This branch (L4452) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (sp->fts_child) {
    ...
    if (sp->fts_options & 512) {
      if (0 <= sp->fts_cwd_fd) {
         ...
         printf("<This branch (L4465) is removed by Cov debloating tool>\n"); exit(6);
      }
    } else {
       ...
       printf("<This branch (L4481) is removed by Cov debloating tool>\n"); exit(6);
    }
    fd_ring_clear(&sp->fts_fd_ring);
    if (sp->fts_leaf_optimization_works_ht) {
       printf("<This branch (L4485) is removed by Cov debloating tool>\n"); exit(6);
    }
    free_dir(sp);
    free((void *)sp);
    if (saved_errno) {
       ...
       printf("<This branch (L4492) is removed by Cov debloating tool>\n"); exit(6);
    }
    return (0);
  }
}
...
FTSENT *(__attribute__((__warn_unused_result__, __leaf__)) fts_read)(FTS *sp) {
  ...
  FTSENT *tmp___32;
  {
    if ((unsigned long)sp->fts_cur == (unsigned long)((void *)0)) {
       printf("<This branch (L4654) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      if (sp->fts_options & 8192) {
         printf("<This branch (L4657) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    p = sp->fts_cur;
    instr = p->fts_instr;
    ...
    if ((int)instr == 1) {
       ...
       printf("<This branch (L4665) is removed by Cov debloating tool>\n"); exit(6);
    }
    if ((int)instr == 2) {
    ...
    if ((int)p->fts_info == 1) {
      ...
      if ((unsigned long)sp->fts_child != (unsigned long)((void *)0)) {
         ...
         printf("<This branch (L4720) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((unsigned long)sp->fts_child != (unsigned long)((void *)0)) {
         ...
         printf("<This branch (L4737) is removed by Cov debloating tool>\n"); exit(6);
      } else {
        ...
        if ((unsigned long)tmp___4 == (unsigned long)((void *)0)) {
           ...
           printf("<This branch (L4755) is removed by Cov debloating tool>\n"); exit(6);
        }
      }
      p = sp->fts_child;
  ...
  next:;
          ...
          if (sp->fts_options & 512) {
            if (sp->fts_options & 512) {
              tmp___5 = -100;
               ...
               printf("<This branch (L4775) is removed by Cov debloating tool>\n"); exit(6);
            }
            ...
            tmp___8 = 0;
             ...
             printf("<This branch (L4786) is removed by Cov debloating tool>\n"); exit(6);
          }
          if (tmp___8) {
             printf("<This branch (L4789) is removed by Cov debloating tool>\n"); exit(6);
          } else {
            tmp___9 = 0;
          }
        } else {
           printf("<This branch (L4794) is removed by Cov debloating tool>\n"); exit(6);
        }
        if (tmp___9) {

           printf("<This branch (L4798) is removed by Cov debloating tool>\n"); exit(6);
        }
        free_dir(sp);
        fts_load(sp, p);
        setup_dir(sp);
    ...
    check_for_dir:;
        ...
        if (p->fts_statp[0].st_size == 2L) {
          ...
          while (1) {
            if (!(p->fts_statp[0].st_size == 1L)) {
               printf("<This branch (L4873) is removed by Cov debloating tool>\n"); exit(6);
            }
      ...
      if ((int)p->fts_info == 1) {
        ...
        if (!tmp___16) {
           ...
           printf("<This branch (L4888) is removed by Cov debloating tool>\n"); exit(6);
        }
      }
      return (p);
    }
    ...
    while (1) {
      if (!((int)p->fts_info != 11)) {
         printf("<This branch (L4906) is removed by Cov debloating tool>\n"); exit(6);
      }
  ...
  while_break___3:;
    *(sp->fts_path + p->fts_pathlen) = (char)'\000';
        ...
        if (sp->fts_options & 512) {
          if (sp->fts_options & 512) {
            tmp___20 = -100;
             ...
             printf("<This branch (L4919) is removed by Cov debloating tool>\n"); exit(6);
          }
          ...
          tmp___23 = 0;
           ...
           printf("<This branch (L4930) is removed by Cov debloating tool>\n"); exit(6);
        }
        if (tmp___23) {
         ...
         printf("<This branch (L4938) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (tmp___24) {


         printf("<This branch (L4943) is removed by Cov debloating tool>\n"); exit(6);
      }
    } else {
      if ((int)p->fts_flags & 2) {
        ...
        if (!((int)p->fts_flags & 1)) {
          ...
          if (tmp___31) {
             ...
             printf("<This branch (L4973) is removed by Cov debloating tool>\n"); exit(6);
          }
        }
      }
    }
    if (p->fts_errno) {
       printf("<This branch (L4979) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      p->fts_info = (unsigned short)6;
    }
    if (p->fts_errno == 0) {
    ...
    if (sp->fts_options & 8192) {
       printf("<This branch (L4991) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      tmp___32 = p;
    }
    return (tmp___32);
        ...
        if (instr != 2) {
          if (instr != 3) {
            if (instr != 4) {
               ...
               printf("<This branch (L5012) is removed by Cov debloating tool>\n"); exit(6);
            }
          }
        }
      }
...
static void set_stat_type(struct stat *st, unsigned int dtype) {
  ...
  {
    if (dtype == 6U) {
       printf("<This branch (L5043) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (dtype == 2U) {
       printf("<This branch (L5046) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (dtype == 4U) {
      goto case_4;
    }
    if (dtype == 1U) {
       printf("<This branch (L5052) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (dtype == 10U) {
    ...
    if (dtype == 8U) {
     ...
     printf("<This branch (L5060) is removed by Cov debloating tool>\n"); exit(6);
...
static FTSENT *fts_build(FTS *sp, int type) {
  ...
  _Bool tmp___27;
  {
    ...
    if (!(sp->fts_options & 4)) {
      if (sp->fts_options & 512) {
        ...
        dirp = tmp___0;
         ...
         printf("<This branch (L5151) is removed by Cov debloating tool>\n"); exit(6);
      }
    } else {

       printf("<This branch (L5155) is removed by Cov debloating tool>\n"); exit(6);
    }
    if ((unsigned long)dirp == (unsigned long)((void *)0)) {
    ...
    if ((int)cur->fts_info == 11) {
      ...
      while_break:;
         ...
         printf("<This branch (L5180) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    if (type == 2) {

       printf("<This branch (L5185) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      if (sp->fts_options & 8) {
        if (sp->fts_options & 16) {
          if (sp->fts_options & 32) {
             printf("<This branch (L5190) is removed by Cov debloating tool>\n"); exit(6);
          } else {
            tmp___4 = 2;
          }
         ...
         printf("<This branch (L5202) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    if (nlinks) {
      goto _L___0;
      ...
      _L___0:;
        ...
        if (dir_fd < 0) {
         ...
         printf("<This branch (L5245) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    ...
    if (sp->fts_options & 4) {
       ...
       printf("<This branch (L5257) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      cp = (char *)((void *)0);
    }
    len++;
    ...
    while (1) {
      ...
      if ((unsigned long)p == (unsigned long)((void *)0)) {
         printf("<This branch (L5293) is removed by Cov debloating tool>\n"); exit(6);
      }
      ...
      if (new_len < len) {
         ...
         printf("<This branch (L5331) is removed by Cov debloating tool>\n"); exit(6);
      }
      p->fts_level = level;
      ...
      if (sp->fts_options & 4) {
         ...
         printf("<This branch (L5339) is removed by Cov debloating tool>\n"); exit(6);
      } else {
        p->fts_accpath = p->fts_name;
      }
      if ((unsigned long)sp->fts_compar == (unsigned long)((void *)0) ||
        ...
        if (sp->fts_options & 16) {
          if (sp->fts_options & 8) {
            if ((int)dp->d_type != 0) {
             ...
             printf("<This branch (L5357) is removed by Cov debloating tool>\n"); exit(6);
          }
        } else {
           printf("<This branch (L5360) is removed by Cov debloating tool>\n"); exit(6);
        }
        ...
        if (sp->fts_options & 16) {
          if ((int)dp->d_type == 4) {
           ...
           printf("<This branch (L5373) is removed by Cov debloating tool>\n"); exit(6);
        }
        is_dir = (_Bool)tmp___18;
         ...
         printf("<This branch (L5391) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (nlinks > 0UL) {
        if (is_dir) {
      ...
      if ((unsigned long)head == (unsigned long)((void *)0)) {
        ...
        head = tail;
         ...
         printf("<This branch (L5404) is removed by Cov debloating tool>\n"); exit(6);
      }
      nitems++;
    __Cont:;
    }
  while_break___0:;
    ...
    if (doadjust) {
       printf("<This branch (L5414) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (sp->fts_options & 4) {
       ...
       printf("<This branch (L5424) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (descend) {
      if (type == 1 || !nitems) {
         ...
         printf("<This branch (L5466) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    if (!nitems) {
       ...
       printf("<This branch (L5474) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (nitems > 10000UL) {
       ...
       printf("<This branch (L5487) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (sp->fts_compar) {


       printf("<This branch (L5492) is removed by Cov debloating tool>\n"); exit(6);
    }
    return (head);
  }
}
static unsigned short fts_stat(FTS *sp, FTSENT *p, _Bool follow) {
  ...
  int tmp___7;
  {
    ...
    if (p->fts_level == 0L) {
      if (sp->fts_options & 1) {
         printf("<This branch (L5513) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    if (sp->fts_options & 2) {
    ...
    if ((sbp->st_mode & 61440U) == 16384U) {
      if (sp->fts_options & 32) {
         printf("<This branch (L5551) is removed by Cov debloating tool>\n"); exit(6);
      } else {
        tmp___6 = 2;
      }
      ...
      if ((int)p->fts_name[0] == 46) {
         ...
         printf("<This branch (L5571) is removed by Cov debloating tool>\n"); exit(6);
      }
    ...
    if ((sbp->st_mode & 61440U) == 32768U) {
     ...
     printf("<This branch (L5581) is removed by Cov debloating tool>\n"); exit(6);
  }
}
...
static _Bool fts_palloc(FTS *sp, size_t more) {
  ...
  int *tmp;
  {
    ...
    if (new_len < sp->fts_pathlen) {
       ...
       printf("<This branch (L5709) is removed by Cov debloating tool>\n"); exit(6);
    }
...
static int fts_safe_changedir(FTS *sp, FTSENT *p, int fd, char const *dir) {
  ...
  int *tmp___6;
  {
    if (dir) {
      ...
      if (tmp == 0) {
        tmp___0 = 1;
         ...
         printf("<This branch (L5806) is removed by Cov debloating tool>\n"); exit(6);
      }
    } else {
      tmp___0 = 0;
    }
    ...
    if (fd < 0) {
       ...
       printf("<This branch (L5840) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (sp->fts_options & 2) {
       printf("<This branch (L5843) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      if (dir) {
         ...
         printf("<This branch (L5867) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    if (sp->fts_options & 512) {
     ...
     printf("<This branch (L5874) is removed by Cov debloating tool>\n"); exit(6);
  bail:;
...
static enum RCH_status restricted_chown(int cwd_fd, char const *file,
  ...
  int *tmp___8;
  {
    ...
    if (required_uid == 4294967295U) {
     ...
     printf("<This branch (L6142) is removed by Cov debloating tool>\n"); exit(6);
...
static _Bool change_file_owner(FTS *fts, FTSENT *ent, uid_t uid, gid_t gid,
  ...
  int tmp___40;
  {
    ...
    if ((int)ent->fts_info == 10) {
       printf("<This branch (L6286) is removed by Cov debloating tool>\n"); exit(6);
    }
    if ((int)ent->fts_info == 7) {
       printf("<This branch (L6289) is removed by Cov debloating tool>\n"); exit(6);
    }
    if ((int)ent->fts_info == 4) {
       printf("<This branch (L6292) is removed by Cov debloating tool>\n"); exit(6);
    }
    if ((int)ent->fts_info == 2) {
       printf("<This branch (L6295) is removed by Cov debloating tool>\n"); exit(6);
    }
    goto switch_default;
  case_1:;
    if (chopt->recurse) {
      if (chopt->root_dev_ino) {
         ...
         printf("<This branch (L6328) is removed by Cov debloating tool>\n"); exit(6);
      }
      return ((_Bool)1);
    }
    goto switch_break;
  ...
  switch_break:;
    if (!ok) {
       ...
       printf("<This branch (L6390) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      if (required_uid == 4294967295U) {
        if (required_gid == 4294967295U) {
          if ((unsigned int const)chopt->verbosity == 2U) {
            if (!chopt->root_dev_ino) {
              if (!chopt->affect_symlink_referent) {
               ...
               printf("<This branch (L6403) is removed by Cov debloating tool>\n"); exit(6);
            }
          } else {
             printf("<This branch (L6406) is removed by Cov debloating tool>\n"); exit(6);
          }
        } else {
           printf("<This branch (L6409) is removed by Cov debloating tool>\n"); exit(6);
        }
      } else {
      _L___3:;
        file_stats = (struct stat const *)(ent->fts_statp);
            ...
            _L:;
              if (required_gid == 4294967295U) {
                tmp___20 = 1;
                 ...
                 printf("<This branch (L6442) is removed by Cov debloating tool>\n"); exit(6);
              }
            } else {
    ...
    if (ok) {
      if ((int)ent->fts_info == 1) {
        ...
        if ((int)ent->fts_info == 2) {
           printf("<This branch (L6459) is removed by Cov debloating tool>\n"); exit(6);
        } else {
          if ((int)ent->fts_info == 6) {
            goto _L___4;
          } else {
            ...
            _L___4:;
              if (chopt->root_dev_ino) {
                 ...
                 printf("<This branch (L6493) is removed by Cov debloating tool>\n"); exit(6);
              }
            }
          }
        }
    ...
    if (do_chown) {
      if (!chopt->affect_symlink_referent) {
        ...
        if (!ok) {
           ...
           printf("<This branch (L6509) is removed by Cov debloating tool>\n"); exit(6);
        }
      } else {
        ...
        if ((unsigned int)err == 5U) {
         ...
         printf("<This branch (L6521) is removed by Cov debloating tool>\n"); exit(6);
      ...
      if (do_chown) {
        if (!ok) {
           ...
           printf("<This branch (L6561) is removed by Cov debloating tool>\n"); exit(6);
        }
      }
    }
    if ((unsigned int const)chopt->verbosity != 2U) {
       ...
       printf("<This branch (L6622) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (!chopt->recurse) {
      fts_set(fts, ent, 4);
    }
...
extern _Bool chown_files(char **files, int bit_flags, uid_t uid, gid_t gid,
  ...
  int tmp___7;
  {
    ...
    if (required_uid != 4294967295U) {
      ...
      if (required_gid != 4294967295U) {
         printf("<This branch (L6652) is removed by Cov debloating tool>\n"); exit(6);
      } else {
        if (chopt->affect_symlink_referent) {
          tmp = 0;
        } else {
          if ((unsigned int const)chopt->verbosity != 2U) {
             printf("<This branch (L6658) is removed by Cov debloating tool>\n"); exit(6);
          } else {
            tmp = 8;
          }
        }
    ...
    while (1) {
      ...
      if ((unsigned long)ent == (unsigned long)((void *)0)) {
        ...
        if (*tmp___3 != 0) {
           ...
           printf("<This branch (L6679) is removed by Cov debloating tool>\n"); exit(6);
        }
        goto while_break;
      }
  ...
  while_break:;
    ...
    if (tmp___7 != 0) {
       ...
       printf("<This branch (L6693) is removed by Cov debloating tool>\n"); exit(6);
    }
    return (ok);
  }
}
...
void usage(int status) {
   ...
   printf("<This branch (L6848) is removed by Cov debloating tool>\n"); exit(6);
}
...
int main(int argc, char **argv) {
  ...
  int tmp___15;
  {
    ...
    while (1) {
      ...
      if (optc == 72) {
         printf("<This branch (L6905) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (optc == 76) {
         printf("<This branch (L6908) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (optc == 80) {
      ...
      if (optc == 128) {
         printf("<This branch (L6917) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (optc == 130) {
         printf("<This branch (L6920) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (optc == 131) {
         printf("<This branch (L6923) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (optc == 132) {
         printf("<This branch (L6926) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (optc == 129) {
      ...
      if (optc == 82) {
       ...
       printf("<This branch (L6934) is removed by Cov debloating tool>\n"); exit(6);
  ...
  while_break:;
    ...
    if (argc - optind < tmp___5) {
       ...
       printf("<This branch (L7034) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (reference_file) {
      ...
      if (!chopt.user_name) {
         ...
         printf("<This branch (L7059) is removed by Cov debloating tool>\n"); exit(6);
      }
      optind++;
    }
    if (chopt.recurse) {
      if (preserve_root) {
         ...
         printf("<This branch (L7071) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    bit_flags |= 1024;
    ...
    if (ok) {
      tmp___15 = 0;
       ...
       printf("<This branch (L7081) is removed by Cov debloating tool>\n"); exit(6);
    }
    exit(tmp___15);
  }
}

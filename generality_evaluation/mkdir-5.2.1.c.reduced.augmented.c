  ...
  char *tmp___6;
  {
    ...
    if (0 <= strtol_base) {
      if (!(strtol_base <= 36)) {
        ...
        } printf("<This branch (L672) is removed by Cov debloating tool>\n"); exit(6);
      }
    } else {
      {
      ...
      } printf("<This branch (L680) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (ptr) {
       printf("<This branch (L683) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      p = &t_ptr;
    }
    q = s;
    {
      ...
      while_continue: /* CIL Label */;
        ...
        if (!((int const) * (*tmp___0 + (int)((unsigned char)*q)) & 8192)) {
         ...
         printf("<This branch (L695) is removed by Cov debloating tool>\n"); exit(6);
      }

    }
  while_break:;
    if ((int const) * q == 45) {
       printf("<This branch (L701) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
    ...
    if ((unsigned long)*p == (unsigned long)s) {
       ...
       printf("<This branch (L725) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      ...
      if (*tmp___4 != 0) {
        {
         ...
         printf("<This branch (L735) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    if (!valid_suffixes) {

       printf("<This branch (L740) is removed by Cov debloating tool>\n"); exit(6);
    }
    if ((int)*(*p) != 0) {
      {
    ...
    switch_break___0:;
       ...
       printf("<This branch (L857) is removed by Cov debloating tool>\n"); exit(6);
    }
    *val = tmp;
    return (err);
  }
...
int save_cwd(struct saved_cwd *cwd) {
  {
    ...
    if (have_working_fchdir) {
      ...
      if (cwd->desc < 0) {
         printf("<This branch (L1441) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    if (!have_working_fchdir) {
      {
       ...
       printf("<This branch (L1450) is removed by Cov debloating tool>\n"); exit(6);
    }
    return (0);
  }
}
  ...
  int tmp___0;
  {
    if (0 <= (int)cwd->desc) {
      ...
      return (tmp < 0);
       ...
       printf("<This branch (L1466) is removed by Cov debloating tool>\n"); exit(6);
    }
  }
}
void free_cwd(struct saved_cwd *cwd) {
  {
    ...
    if (cwd->name) {
      ...
      } printf("<This branch (L1480) is removed by Cov debloating tool>\n"); exit(6);
    }
    return;
  }
}
...
static size_t quotearg_buffer_restyled(char *buffer, size_t buffersize,
  ...
  char *__cil_tmp37;
  {
    ...
    if ((unsigned int)quoting_style == 4U) {
       printf("<This branch (L1720) is removed by Cov debloating tool>\n"); exit(6);
    }
    if ((unsigned int)quoting_style == 6U) {
       printf("<This branch (L1723) is removed by Cov debloating tool>\n"); exit(6);
    }
    if ((unsigned int)quoting_style == 5U) {
      goto case_6;
    }
     printf("<This branch (L1728) is removed by Cov debloating tool>\n"); exit(6);
      ...
      while_continue___3: /* CIL Label */;
        if (argsize == 0xffffffffffffffffUL) {
          tmp___7 = (int const) * (arg + i) == 0;
           ...
           printf("<This branch (L1811) is removed by Cov debloating tool>\n"); exit(6);
        }
        if (tmp___7) {
          ...
          if (quote_string_len) {
            if (i + quote_string_len <= argsize) {
              ...
              if (tmp___2 == 0) {
               ...
               printf("<This branch (L1835) is removed by Cov debloating tool>\n"); exit(6);
              }
            }
          }
        }
        ...
        if ((int)c == 0) {
           printf("<This branch (L1842) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 63) {
           printf("<This branch (L1845) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 7) {
           printf("<This branch (L1848) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 8) {
           printf("<This branch (L1851) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 12) {
           printf("<This branch (L1854) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 10) {
           printf("<This branch (L1857) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 13) {
           printf("<This branch (L1860) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 9) {
           printf("<This branch (L1863) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 11) {
           printf("<This branch (L1866) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 92) {
           printf("<This branch (L1869) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 126) {
           printf("<This branch (L1872) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 35) {
           printf("<This branch (L1875) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 124) {
           printf("<This branch (L1878) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 96) {
           printf("<This branch (L1881) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 94) {
           printf("<This branch (L1884) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 91) {
           printf("<This branch (L1887) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 62) {
           printf("<This branch (L1890) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 60) {
           printf("<This branch (L1893) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 59) {
           printf("<This branch (L1896) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 42) {
           printf("<This branch (L1899) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 41) {
           printf("<This branch (L1902) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 40) {
           printf("<This branch (L1905) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 38) {
           printf("<This branch (L1908) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 36) {
           printf("<This branch (L1911) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 34) {
           printf("<This branch (L1914) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 33) {
           printf("<This branch (L1917) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 32) {
           printf("<This branch (L1920) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 39) {
           printf("<This branch (L1923) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 125) {
           printf("<This branch (L1926) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 123) {
           printf("<This branch (L1929) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 122) {
           printf("<This branch (L1932) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 121) {
        ...
        if ((int)c == 118) {
           printf("<This branch (L1944) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 117) {
           printf("<This branch (L1947) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 116) {
           printf("<This branch (L1950) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 115) {
           printf("<This branch (L1953) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 114) {
           printf("<This branch (L1956) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 113) {
           printf("<This branch (L1959) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 112) {
           printf("<This branch (L1962) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 111) {
           printf("<This branch (L1965) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 110) {
           printf("<This branch (L1968) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 109) {
           printf("<This branch (L1971) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 108) {
           printf("<This branch (L1974) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 107) {
           printf("<This branch (L1977) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 106) {
           printf("<This branch (L1980) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 105) {
           printf("<This branch (L1983) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 104) {
           printf("<This branch (L1986) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 103) {
           printf("<This branch (L1989) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 102) {
           printf("<This branch (L1992) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 101) {
           printf("<This branch (L1995) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 100) {
          goto case_125;
        }
        if ((int)c == 99) {
           printf("<This branch (L2001) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 98) {
           printf("<This branch (L2004) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 97) {
           printf("<This branch (L2007) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 95) {
           printf("<This branch (L2010) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 93) {
           printf("<This branch (L2013) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 90) {
           printf("<This branch (L2016) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 89) {
           printf("<This branch (L2019) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 88) {
           printf("<This branch (L2022) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 87) {
           printf("<This branch (L2025) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 86) {
           printf("<This branch (L2028) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 85) {
           printf("<This branch (L2031) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 84) {
           printf("<This branch (L2034) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 83) {
           printf("<This branch (L2037) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 82) {
           printf("<This branch (L2040) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 81) {
           printf("<This branch (L2043) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 80) {
           printf("<This branch (L2046) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 79) {
           printf("<This branch (L2049) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 78) {
           printf("<This branch (L2052) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 77) {
           printf("<This branch (L2055) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 76) {
           printf("<This branch (L2058) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 75) {
        ...
        if ((int)c == 73) {
           printf("<This branch (L2067) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 72) {
           printf("<This branch (L2070) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 71) {
           printf("<This branch (L2073) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 70) {
           printf("<This branch (L2076) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 69) {
           printf("<This branch (L2079) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 68) {
           printf("<This branch (L2082) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 67) {
           printf("<This branch (L2085) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 66) {
           printf("<This branch (L2088) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 65) {
           printf("<This branch (L2091) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 61) {
           printf("<This branch (L2094) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 58) {
           printf("<This branch (L2097) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 57) {
           printf("<This branch (L2100) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 56) {
           printf("<This branch (L2103) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 55) {
           printf("<This branch (L2106) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 54) {
           printf("<This branch (L2109) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 53) {
           printf("<This branch (L2112) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 52) {
          goto case_125;
        }
        ...
        if ((int)c == 48) {
           printf("<This branch (L2127) is removed by Cov debloating tool>\n"); exit(6);
        }
        if ((int)c == 47) {
          goto case_125;
        }
      ...
      switch_break___0:;
        if (backslash_escapes) {
          if (!(o->quote_these_too[(unsigned long)c / (sizeof(int) * 8UL)] &
           ...
           printf("<This branch (L2529) is removed by Cov debloating tool>\n"); exit(6);
        }
       printf("<This branch (L2531) is removed by Cov debloating tool>\n"); exit(6);
  ...
  int *tmp___2;
  {
    if (o) {
      tmp = o;
       ...
       printf("<This branch (L2609) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
      p = tmp;
...
static char *quotearg_n_options(int n, char const *arg, size_t argsize,
  ...
  int *tmp___5;
  {
    ...
    if (n < 0) {
      ...
      } printf("<This branch (L2654) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (nslots <= n0) {
      ...
      } printf("<This branch (L2682) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
      size = (slotvec + n)->size;
      val = (slotvec + n)->val;
    ...
    if (size <= qsize) {
      ...
      } printf("<This branch (L2703) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
  ...
  struct mode_change *tmp;
  {
    if ((unsigned long)*head == (unsigned long)((void *)0)) {
      ...
      *head = tmp;
       ...
       printf("<This branch (L2833) is removed by Cov debloating tool>\n"); exit(6);
    }
    return;
  }
}
struct mode_change *mode_compile(char const *mode_string___0,
  ...
  char *__cil_tmp33;
  {
    ...
    if ((unsigned int)tmp___11 == 0U) {
              ...
              if ((128 >> 3) >> 3 == 2) {
                if ((64 >> 3) >> 3 == 1) {
                  mode = (mode_t)octal_value;
                   ...
                   printf("<This branch (L2889) is removed by Cov debloating tool>\n"); exit(6);
                }
              } else {
                 printf("<This branch (L2892) is removed by Cov debloating tool>\n"); exit(6);
              }
            } else {
               printf("<This branch (L2895) is removed by Cov debloating tool>\n"); exit(6);
            }
          } else {
             printf("<This branch (L2898) is removed by Cov debloating tool>\n"); exit(6);
          }
        } else {
      ...
      if ((unsigned long)p == (unsigned long)((void *)0)) {
         printf("<This branch (L2977) is removed by Cov debloating tool>\n"); exit(6);
      }
    ...
    newmode = oldmode & (unsigned int)((4032 | (448 >> 3)) | ((448 >> 3) >> 3));
    {
      ...
      while_continue: /* CIL Label */;
        ...
        if ((int const)changes->flags & 2) {
           ...
           printf("<This branch (L3276) is removed by Cov debloating tool>\n"); exit(6);
        } else {
      ...
      if (tmp___5) {
        {
         ...
         printf("<This branch (L3423) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    if (created_dir_p) {
  ...
  char *__cil_tmp109;
  {
    ...
    if (tmp___65) {
      ...
      if ((parent_mode & 192) != 192) {
         ...
         printf("<This branch (L3557) is removed by Cov debloating tool>\n"); exit(6);
      } else {
        if (owner != 4294967295U) {
           printf("<This branch (L3560) is removed by Cov debloating tool>\n"); exit(6);
        } else {
        ...
        if ((int)*dirpath == 47) {
          {
           ...
           printf("<This branch (L3591) is removed by Cov debloating tool>\n"); exit(6);
        }
      }
      slash = dirpath;
      {
    ...
    while_break:;
      {
        ...
        while_continue___0: /* CIL Label */;
          ...
          if (!do_chdir) {
             printf("<This branch (L3617) is removed by Cov debloating tool>\n"); exit(6);
          }
          {
            *slash = (char)'\000';
          ...
          if (fail) {
            {
             ...
             printf("<This branch (L3662) is removed by Cov debloating tool>\n"); exit(6);
          }
          if (newly_created_dir) {
            if (verbose_fmt_string) {
              ...
              } printf("<This branch (L3669) is removed by Cov debloating tool>\n"); exit(6);
            }
            if (owner != 4294967295U) {
               printf("<This branch (L3672) is removed by Cov debloating tool>\n"); exit(6);
            } else {
              if (group != 4294967295U) {
                 ...
                 printf("<This branch (L3725) is removed by Cov debloating tool>\n"); exit(6);
              }
            }
            if (re_protect) {
              {
              ...
              } printf("<This branch (L3735) is removed by Cov debloating tool>\n"); exit(6);
            }
          }
          if (do_chdir) {
            {
            ...
            if (tmp___29 < 0) {
              ...
              }
              {
               ...
               printf("<This branch (L3787) is removed by Cov debloating tool>\n"); exit(6);
            }
          }
          tmp___30 = slash;
          slash++;
          *tmp___30 = (char)'/';
          {
            ...
            while_continue___7: /* CIL Label */;
              if (!((int)*slash == 47)) {
               ...
               printf("<This branch (L3799) is removed by Cov debloating tool>\n"); exit(6);
            }
    ...
    while_break___0:;
      if (!do_chdir) {
         printf("<This branch (L3809) is removed by Cov debloating tool>\n"); exit(6);
      }
      {
        umask(oldmask);
      ...
      if (tmp___36) {
        {
         ...
         printf("<This branch (L3854) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((unsigned long)verbose_fmt_string != (unsigned long)((void *)0)) {
        {


        } printf("<This branch (L3860) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (owner != 4294967295U) {
        ...
        if (group != 4294967295U) {
           ...
           printf("<This branch (L3875) is removed by Cov debloating tool>\n"); exit(6);
        }
      }
      if (mode & ~((448 | (448 >> 3)) | ((448 >> 3) >> 3))) {
        {
         ...
         printf("<This branch (L3890) is removed by Cov debloating tool>\n"); exit(6);
      }
      {
        while (1) {
            ...
            if (tmp___50 != 0) {
              {
               ...
               printf("<This branch (L3911) is removed by Cov debloating tool>\n"); exit(6);
            }
            { free_cwd(&cwd); }
          }
    ...
    while_break___11:;
       ...
       printf("<This branch (L3982) is removed by Cov debloating tool>\n"); exit(6);
    }
    return (retval);
  }
}
...
void close_stdout(void) {
  ...
  char *__cil_tmp10;
  {
    ...
    if (tmp___1) {
       printf("<This branch (L4630) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      tmp___0 = -1;
    }
    e = tmp___0;
    if (e) {
     ...
     printf("<This branch (L4643) is removed by Cov debloating tool>\n"); exit(6);
      ...
      while_continue: /* CIL Label */;
        if (1UL < len) {
          if (!((int const) * (name + (len - 1UL)) == 47)) {
           ...
           printf("<This branch (L4727) is removed by Cov debloating tool>\n"); exit(6);
        }
...
void usage(int status) {
  ...
  char *__cil_tmp17;
  {
    if (status != 0) {
      ...
      } printf("<This branch (L4836) is removed by Cov debloating tool>\n"); exit(6);
    }
    { exit(status); }
  }
}
  ...
  char *__cil_tmp36;
  {
    ...
    }
    {
      ...
      while_continue: /* CIL Label */;
        ...
        if (optc == 0) {
           printf("<This branch (L4900) is removed by Cov debloating tool>\n"); exit(6);
        }
        if (optc == 112) {
          goto case_112;
        }
        if (optc == 109) {
         ...
         printf("<This branch (L4908) is removed by Cov debloating tool>\n"); exit(6);
    ...
    if (specified_mode) {
      ...
      if ((unsigned long)change == (unsigned long)((struct mode_change *)0)) {
        ...
        if ((unsigned long)change == (unsigned long)((struct mode_change *)1)) {
          ...
          } printf("<This branch (L4976) is removed by Cov debloating tool>\n"); exit(6);
        }
      }
          ...
          if (!fail) {
            if (!create_parents) {
              if (!dir_created) {
                ...
                } printf("<This branch (L5007) is removed by Cov debloating tool>\n"); exit(6);
              } else {
                goto _L;
              }
            } else {
            _L:;
              if (verbose_fmt_string) {
                ...
                } printf("<This branch (L5017) is removed by Cov debloating tool>\n"); exit(6);
              }
            }
          }
          if (fail == 0) {
            if (specified_mode) {
              if (dir_created) {
                ...
                if (fail) {
                  ...
                  } printf("<This branch (L5034) is removed by Cov debloating tool>\n"); exit(6);
                }
              }
            }
          }

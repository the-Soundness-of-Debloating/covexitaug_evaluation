...
void close_stdout(void) {
  ...
  int tmp___5;
  {
    ...
    if (tmp___3 != 0) {
       ...
       printf("<This branch (L818) is removed by Cov debloating tool>\n"); exit(6);
    }
    tmp___5 = close_stream(stderr);
    if (tmp___5 != 0) {
       printf("<This branch (L822) is removed by Cov debloating tool>\n"); exit(6);
    }
    return;
  }
}
...
int close_stream(FILE *stream) {
  ...
  int *tmp___3;
  {
    ...
    if (prev_fail) {
       printf("<This branch (L853) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      if (fclose_fail) {
         ...
         printf("<This branch (L868) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    return (0);
  }
  ...
  void *tmp___0;
  {
    if (sizeof(ptrdiff_t) <= sizeof(size_t)) {
      tmp = -1;
       ...
       printf("<This branch (L1268) is removed by Cov debloating tool>\n"); exit(6);
    }
    if ((size_t)tmp / s < n) {
       printf("<This branch (L1271) is removed by Cov debloating tool>\n"); exit(6);
    }
    tmp___0 = xmalloc(n * s);
    return (tmp___0);
  }
...
void xstrtol_fatal(enum strtol_error err, int opt_idx, char c,
   ...
   printf("<This branch (L1841) is removed by Cov debloating tool>\n"); exit(6);
}
extern __attribute__((__nothrow__)) int(__attribute__((__leaf__))
  ...
  void *tmp;
  {
    ...
    if (!p) {
      if (!n) {
       ...
       printf("<This branch (L1936) is removed by Cov debloating tool>\n"); exit(6);
    }
    *pn = n;
    tmp = xrealloc(p, n * s);
    return (tmp);
...
void *xrealloc(void *p, size_t n) {
  {
    if (!n) {
       ...
       printf("<This branch (L1973) is removed by Cov debloating tool>\n"); exit(6);
    }
    p = realloc(p, n);
    if (!p) {


       printf("<This branch (L1979) is removed by Cov debloating tool>\n"); exit(6);
    }
    return (p);
  }
}
...
void set_program_name(char const *argv0) {
  ...
  int tmp___0;
  {
    if ((unsigned long)argv0 == (unsigned long)((void *)0)) {
       ...
       printf("<This branch (L4987) is removed by Cov debloating tool>\n"); exit(6);
    }
    slash = (char const *)strrchr(argv0, '/');
    if ((unsigned long)slash != (unsigned long)((void *)0)) {
      base = slash + 1;
    } else {
       printf("<This branch (L4993) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (base - argv0 >= 7L) {
...
int posix2_version(void) {
  ...
  long tmp___2;
  {
    ...
    if (v < (-0x7FFFFFFF - 1)) {
       printf("<This branch (L5035) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      if (v < 2147483647L) {
        tmp___1 = v;
      } else {
         printf("<This branch (L5040) is removed by Cov debloating tool>\n"); exit(6);
      }
      tmp___2 = tmp___1;
    }
    return ((int)tmp___2);
...
double physmem_total(void) {
  ...
  double tmp___0;
  {
    ...
    if ((double)0 <= pages) {
     ...
     printf("<This branch (L5071) is removed by Cov debloating tool>\n"); exit(6);
  }
}
double physmem_available(void) {
  double pages;
  ...
  double tmp___1;
  {
    ...
    if ((double)0 <= pages) {
     ...
     printf("<This branch (L5090) is removed by Cov debloating tool>\n"); exit(6);
  ...
  unsigned long tmp___8;
  {
    if ((unsigned int)query == 2U) {
      ...
      while_break:;
         ...
         printf("<This branch (L5183) is removed by Cov debloating tool>\n"); exit(6);
      }
    ...
    if ((unsigned int)query == 1U) {
      ...
      if (nprocs___0 > 0UL) {
       ...
       printf("<This branch (L5210) is removed by Cov debloating tool>\n"); exit(6);
    }
...
struct heap *heap_alloc(int (*compare___0)(void const *, void const *),
  ...
  struct heap *tmp;
  {
    ...
    heap = tmp;
    if (n_reserve == 0UL) {
       printf("<This branch (L6937) is removed by Cov debloating tool>\n"); exit(6);
    }
...
int heap_insert(struct heap *heap, void *item) {
  {
    if (heap->capacity - 1UL <= heap->count) {
                                         ...
                                         printf("<This branch (L6962) is removed by Cov debloating tool>\n"); exit(6);
    }
    (heap->count)++;
  ...
  int tmp___0;
  {
    ...
    while (1) {
      if (!(parent <= count / 2UL)) {
       ...
       printf("<This branch (L6999) is removed by Cov debloating tool>\n"); exit(6);
  ...
  int tmp;
  {
    ...
    while (1) {
      if (k != 1UL) {
       ...
       printf("<This branch (L7038) is removed by Cov debloating tool>\n"); exit(6);
      ...
      if (1) {
        ...
        if (tmp___0 == 0) {
          hard = (_Bool)0;
           ...
           printf("<This branch (L7697) is removed by Cov debloating tool>\n"); exit(6);
        }
      } else {
         ...
         printf("<This branch (L7723) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    return (hard);
  }
...
__inline static void clear_ungetc_buffer_preserving_position(FILE *fp) {
  {
    if (fp->_flags & 256) {
       printf("<This branch (L8104) is removed by Cov debloating tool>\n"); exit(6);
    }
    return;
  }
}
int rpl_fflush(FILE *stream) {
  ...
  int tmp___1;
  {
    if ((unsigned long)stream == (unsigned long)((void *)0)) {
       ...
       printf("<This branch (L8116) is removed by Cov debloating tool>\n"); exit(6);
    } else {
...
int(__attribute__((__nonnull__(1))) rpl_fclose)(FILE *fp) {
  ...
  int *tmp___5;
  {
    ...
    if (fd < 0) {
       ...
       printf("<This branch (L8245) is removed by Cov debloating tool>\n"); exit(6);
    }
    ...
    if (tmp___1 != 0) {
      ...
      _L:;
        ...
        if (tmp___4) {
           ...
           printf("<This branch (L8256) is removed by Cov debloating tool>\n"); exit(6);
        }
      }
    } else {
      goto _L;
    ...
    if (saved_errno != 0) {
       ...
       printf("<This branch (L8266) is removed by Cov debloating tool>\n"); exit(6);
    }
    return (result);
  }
}
...
static void die(char const *message, char const *file) {
   ...
   printf("<This branch (L8516) is removed by Cov debloating tool>\n"); exit(6);
}
__attribute__((__noreturn__)) void usage(int status);
...
static void reap_all(void) {
  {
    while (1) {
      if (!(0 < nprocs)) {
       ...
       printf("<This branch (L8878) is removed by Cov debloating tool>\n"); exit(6);
    }
  while_break:;
    return;
  }
...
static void exit_cleanup(void) {
  ...
  struct cs_status tmp;
  {
    if (temphead) {
       ...
       printf("<This branch (L8908) is removed by Cov debloating tool>\n"); exit(6);
    }
    close_stdout();
    return;
  }
  ...
  FILE *tmp___0;
  {
    ...
    if ((int const) * how == 114) {
      ...
      if (tmp == 0) {
         ...
         printf("<This branch (L8998) is removed by Cov debloating tool>\n"); exit(6);
      } else {
     ...
     printf("<This branch (L9005) is removed by Cov debloating tool>\n"); exit(6);
...
static FILE *xfopen(char const *file, char const *how) {
  ...
  char *tmp___0;
  {
    ...
    if (!fp) {
       ...
       printf("<This branch (L9018) is removed by Cov debloating tool>\n"); exit(6);
    }
    return (fp);
  }
}
static void xfclose(FILE *fp, char const *file) {
  ...
  int tmp___4;
  {
    tmp = fileno(fp);
    if (tmp == 0) {
       printf("<This branch (L9033) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (tmp == 1) {
      goto case_1;
    }
  ...
  case_1:;
    ...
    if (tmp___2 != 0) {
       ...
       printf("<This branch (L9049) is removed by Cov debloating tool>\n"); exit(6);
    }
    goto switch_break;
  switch_default:;
    ...
    if (tmp___4 != 0) {
       ...
       printf("<This branch (L9056) is removed by Cov debloating tool>\n"); exit(6);
    }
    goto switch_break;
  switch_break:;
    return;
...
static void inittables(void) {
  ...
  while_break:;
    ...
    while_break___0:;
             ...
             printf("<This branch (L9431) is removed by Cov debloating tool>\n"); exit(6);
    }
    return;
  }
}
  ...
  size_t tmp___5;
  {
    ...
    if (avail > total / (double)8) {
      tmp___1 = avail;
       ...
       printf("<This branch (L9610) is removed by Cov debloating tool>\n"); exit(6);
    }
    mem = tmp___1;
    ...
    if (tmp___3 == 0) {
      if (rlimit.rlim_cur < size) {
         printf("<This branch (L9623) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    size /= 2UL;
    ...
    if (tmp___4 == 0) {
      if ((rlimit.rlim_cur / 16UL) * 15UL < size) {
         printf("<This branch (L9630) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    if (mem < (double)size) {
      size = (size_t)mem;
    ...
    if (size > (unsigned long)nmerge * (2UL + sizeof(struct line))) {
      tmp___5 = size;
       ...
       printf("<This branch (L9639) is removed by Cov debloating tool>\n"); exit(6);
    }
    return (tmp___5);
  }
}
    ...
    while (1) {
      ...
      if (i < nfps) {
        ...
        tmp___7 = tmp___1;
         ...
         printf("<This branch (L9683) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (tmp___7 != 0) {
      ...
      if ((size_t)file_size != worst_case / worst_case_per_input_byte) {
        ...
        if (size_bound - size <= worst_case) {
           printf("<This branch (L9708) is removed by Cov debloating tool>\n"); exit(6);
        }
      }
      size += worst_case;
      i++;
  ...
  size_t tmp___0;
  {
    while (1) {
      ...
      if (buf___1->buf) {
       ...
       printf("<This branch (L9728) is removed by Cov debloating tool>\n"); exit(6);
...
static _Bool fillbuf___7(struct buffer *buf___1, FILE *fp, char const *file) {
  ...
  size_t line_alloc;
  {
    ...
    if (buf___1->eof) {
       printf("<This branch (L9994) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (buf___1->used != buf___1->left) {
       ...
       printf("<This branch (L10001) is removed by Cov debloating tool>\n"); exit(6);
    }
    while (1) {
      ...
      if (buf___1->nlines) {
         printf("<This branch (L10010) is removed by Cov debloating tool>\n"); exit(6);
      } else {
        tmp___0 = buf___1->buf;
      }
      line_start = tmp___0;
      while (1) {
        if (!(line_bytes + 1UL < avail)) {
           printf("<This branch (L10017) is removed by Cov debloating tool>\n"); exit(6);
        }
        ...
        if (bytes_read != readsize) {
          ...
          if (tmp___3) {
             ...
             printf("<This branch (L10028) is removed by Cov debloating tool>\n"); exit(6);
          }
          tmp___5 = feof_unlocked(fp);
          if (tmp___5) {
            buf___1->eof = (_Bool)1;
            if ((unsigned long)buf___1->buf == (unsigned long)ptrlim) {
               printf("<This branch (L10034) is removed by Cov debloating tool>\n"); exit(6);
            }
    ...
    while_break___0:;
      ...
      if (buf___1->nlines != 0UL) {
       ...
       printf("<This branch (L10102) is removed by Cov debloating tool>\n"); exit(6);
...
__inline static _Bool key_numeric(struct keyfield const *key) {
  ...
  {
    if (key->numeric) {
       printf("<This branch (L10680) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      if (key->general_numeric) {
         printf("<This branch (L10683) is removed by Cov debloating tool>\n"); exit(6);
      } else {
...
static _Bool default_key_compare(struct keyfield const *key) {
  ...
  {
    if (key->ignore) {
       printf("<This branch (L10864) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      if (key->translate) {
         printf("<This branch (L10867) is removed by Cov debloating tool>\n"); exit(6);
      } else {
        if (key->skipsblanks) {
           printf("<This branch (L10870) is removed by Cov debloating tool>\n"); exit(6);
        } else {
          if (key->skipeblanks) {
             printf("<This branch (L10873) is removed by Cov debloating tool>\n"); exit(6);
          } else {
            tmp = key_numeric(key);
            if (tmp) {
              ...
              if (key->month) {
                 printf("<This branch (L10880) is removed by Cov debloating tool>\n"); exit(6);
              } else {
                if (key->version) {
                   printf("<This branch (L10883) is removed by Cov debloating tool>\n"); exit(6);
                } else {
                  if (key->random) {
                     printf("<This branch (L10886) is removed by Cov debloating tool>\n"); exit(6);
                  } else {
                    tmp___0 = 1;
                  }
                }
...
static int compare(struct line const *a, struct line const *b) {
  ...
  int tmp___0;
  {
    if (keylist) {
       ...
       printf("<This branch (L11688) is removed by Cov debloating tool>\n"); exit(6);
    }
    ...
    if (alen == 0UL) {
      ...
      if (blen == 0UL) {
        ...
        if (hard_LC_COLLATE) {
                            ...
                            printf("<This branch (L11700) is removed by Cov debloating tool>\n"); exit(6);
        } else {
          if (alen < blen) {
            tmp = alen;
          } else {
...
static void write_line(struct line const *line, FILE *fp,
  ...
  size_t tmp___3;
  {
    ...
    if (!output_file) {
      ...
      while_break:;
         printf("<This branch (L11766) is removed by Cov debloating tool>\n"); exit(6);
      } else {
        goto _L;
      }
    } else {
    _L:;
      *(ebuf + -1) = eolchar;
      ...
      if (tmp___3 != n_bytes) {
         ...
         printf("<This branch (L11776) is removed by Cov debloating tool>\n"); exit(6);
      }
      *(ebuf + -1) = (char)'\000';
    }
    return;
  ...
  struct merge_node *node;
  {
    ...
    while (1) {
      ...
      if (node) {
       ...
       printf("<This branch (L12487) is removed by Cov debloating tool>\n"); exit(6);
    }
  while_break:;
    pthread_mutex_unlock(&queue->mutex);
    lock_node(node);
...
static void mergelines_node(struct merge_node *__restrict node,
  ...
  size_t tmp___6;
  {
    ...
    while_break:;
       ...
       printf("<This branch (L12601) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      while (1) {
        ...
        if (hi_avail) {
          ...
          if (!node->nhi) {
            tmp = 1;
             ...
             printf("<This branch (L12689) is removed by Cov debloating tool>\n"); exit(6);
          }
        }
        tmp___1 = tmp;
      } else {
        if (hi_avail) {
          if (!node->nlo) {
            tmp___0 = 1;
             ...
             printf("<This branch (L12698) is removed by Cov debloating tool>\n"); exit(6);
          }
        } else {
          tmp___0 = 0;
        }
...
static void queue_check_insert_parent(struct merge_node_queue *queue,
                                      struct merge_node *node) {
  {
    if (node->level > 1U) {
       ...
       printf("<This branch (L12718) is removed by Cov debloating tool>\n"); exit(6);
    } else {
  ...
  int tmp;
  {
    ...
    if (nthreads > 1UL) {
      if (131072UL <= nlines) {
         ...
         printf("<This branch (L12798) is removed by Cov debloating tool>\n"); exit(6);
      } else {
        goto _L___0;
      }
    } else {
...
static void sort(char *const *files, size_t nfiles, char const *output_file,
  ...
  struct sortfile *tmp___5;
  {
    ...
    while (1) {
      if (!nfiles) {
         printf("<This branch (L13106) is removed by Cov debloating tool>\n"); exit(6);
      }
      ...
      while_break___0:;
        bytes_per_line = mult * sizeof(struct line);
         ...
         printf("<This branch (L13124) is removed by Cov debloating tool>\n"); exit(6);
      }
      if (!buf___1.alloc) {
      ...
      while (1) {
        ...
        if (!tmp___4) {
           printf("<This branch (L13137) is removed by Cov debloating tool>\n"); exit(6);
        }
        if (buf___1.eof) {
          if (nfiles) {
             ...
             printf("<This branch (L13145) is removed by Cov debloating tool>\n"); exit(6);
          }
        }
          ...
          if (!nfiles) {
            if (!ntemps) {
              if (!buf___1.left) {
               ...
               printf("<This branch (L13165) is removed by Cov debloating tool>\n"); exit(6);
            }
          } else {


             printf("<This branch (L13170) is removed by Cov debloating tool>\n"); exit(6);
          }
        } else {
  ...
  finish:;
    ...
    while_break___2:;
       ...
       printf("<This branch (L13217) is removed by Cov debloating tool>\n"); exit(6);
    }
    reap_all();
    return;
  }
...
static void badfieldspec(char const *spec, char const *msgid) {
   ...
   printf("<This branch (L13259) is removed by Cov debloating tool>\n"); exit(6);
}
...
static void incompatible_options(char const *opts___1) {
   ...
   printf("<This branch (L13271) is removed by Cov debloating tool>\n"); exit(6);
}
  ...
  _Bool tmp___0;
  {
    ...
    while (1) {
      if (!key) {
       ...
       printf("<This branch (L13284) is removed by Cov debloating tool>\n"); exit(6);
...
static char *set_ordering(char const *s, struct keyfield *key,
                          enum blanktype blanktype) {
  {
    while (1) {
      ...
      if ((int const) * s == 98) {
         printf("<This branch (L13356) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int const) * s == 100) {
         printf("<This branch (L13359) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int const) * s == 102) {
         printf("<This branch (L13362) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int const) * s == 103) {
         printf("<This branch (L13365) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int const) * s == 104) {
         printf("<This branch (L13368) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int const) * s == 105) {
         printf("<This branch (L13371) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int const) * s == 77) {
         printf("<This branch (L13374) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int const) * s == 110) {
         printf("<This branch (L13377) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int const) * s == 82) {
         printf("<This branch (L13380) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((int const) * s == 114) {
        goto case_114;
      }
       printf("<This branch (L13385) is removed by Cov debloating tool>\n"); exit(6);
...
int main(int argc, char **argv) {
  ...
  int tmp___61;
  {
    ...
    if (!decimal_point) {
       printf("<This branch (L13595) is removed by Cov debloating tool>\n"); exit(6);
    } else {
  ...
  while_break___0:;
    ...
    while (1) {
      oi = -1;
      if (c == -1) {
         printf("<This branch (L13649) is removed by Cov debloating tool>\n"); exit(6);
      } else {
        if (posixly_correct) {
           ...
           printf("<This branch (L13684) is removed by Cov debloating tool>\n"); exit(6);
        } else {
        _L___1:;
          ...
          _L:;
            ...
            if (c == 134) {
               printf("<This branch (L13704) is removed by Cov debloating tool>\n"); exit(6);
            }
            if (c == 98) {
               printf("<This branch (L13707) is removed by Cov debloating tool>\n"); exit(6);
            }
            if (c == 100) {
               printf("<This branch (L13710) is removed by Cov debloating tool>\n"); exit(6);
            }
            if (c == 102) {
               printf("<This branch (L13713) is removed by Cov debloating tool>\n"); exit(6);
            }
            if (c == 103) {
               printf("<This branch (L13716) is removed by Cov debloating tool>\n"); exit(6);
            }
            if (c == 104) {
               printf("<This branch (L13719) is removed by Cov debloating tool>\n"); exit(6);
            }
            if (c == 105) {
               printf("<This branch (L13722) is removed by Cov debloating tool>\n"); exit(6);
            }
            if (c == 77) {
               printf("<This branch (L13725) is removed by Cov debloating tool>\n"); exit(6);
            }
            if (c == 110) {
               printf("<This branch (L13728) is removed by Cov debloating tool>\n"); exit(6);
            }
            if (c == 114) {
              goto case_98;
            }
            if (c == 82) {
               printf("<This branch (L13734) is removed by Cov debloating tool>\n"); exit(6);
            }
            if (c == 86) {
               printf("<This branch (L13737) is removed by Cov debloating tool>\n"); exit(6);
            }
            if (c == 128) {
               printf("<This branch (L13740) is removed by Cov debloating tool>\n"); exit(6);
            }
            if (c == 99) {
               printf("<This branch (L13743) is removed by Cov debloating tool>\n"); exit(6);
            }
            if (c == 67) {
               printf("<This branch (L13746) is removed by Cov debloating tool>\n"); exit(6);
            }
            if (c == 129) {
               printf("<This branch (L13749) is removed by Cov debloating tool>\n"); exit(6);
            }
            if (c == 130) {
               printf("<This branch (L13752) is removed by Cov debloating tool>\n"); exit(6);
            }
            if (c == 131) {
               printf("<This branch (L13755) is removed by Cov debloating tool>\n"); exit(6);
            }
            if (c == 107) {
               printf("<This branch (L13758) is removed by Cov debloating tool>\n"); exit(6);
            }
            if (c == 109) {
               printf("<This branch (L13761) is removed by Cov debloating tool>\n"); exit(6);
            }
            if (c == 132) {
               printf("<This branch (L13764) is removed by Cov debloating tool>\n"); exit(6);
            }
            if (c == 111) {
               printf("<This branch (L13767) is removed by Cov debloating tool>\n"); exit(6);
            }
            if (c == 133) {
               printf("<This branch (L13770) is removed by Cov debloating tool>\n"); exit(6);
            }
            if (c == 115) {
              goto case_115;
            }
            if (c == 83) {
               printf("<This branch (L13776) is removed by Cov debloating tool>\n"); exit(6);
            }
            if (c == 116) {
            ...
            if (c == 135) {
               printf("<This branch (L13785) is removed by Cov debloating tool>\n"); exit(6);
            }
            if (c == 117) {
              goto case_117;
            }
            if (c == 121) {
               printf("<This branch (L13791) is removed by Cov debloating tool>\n"); exit(6);
            }
            if (c == 122) {
              goto case_122;
            }
             printf("<This branch (L13796) is removed by Cov debloating tool>\n"); exit(6);
          ...
          case_1:;
            ...
            if ((int)*(optarg + 0) == 43) {
               ...
               printf("<This branch (L13876) is removed by Cov debloating tool>\n"); exit(6);
            }
            if (!key) {
              tmp___10 = nfiles;
              nfiles++;
  ...
  while_break___1:;
    if (files_from) {
       ...
       printf("<This branch (L14141) is removed by Cov debloating tool>\n"); exit(6);
    }
    key = keylist;
    while (1) {
      if (!key) {
       ...
       printf("<This branch (L14148) is removed by Cov debloating tool>\n"); exit(6);
  ...
  while_break___4:;
    ...
    if (debug) {
       ...
       printf("<This branch (L14200) is removed by Cov debloating tool>\n"); exit(6);
    }
    reverse = gkey.reverse;
    if (need_random) {
       printf("<This branch (L14204) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (temp_dir_count == 0UL) {
      tmp___51 = (char const *)getenv("TMPDIR");
      tmp_dir = tmp___51;
      if (tmp_dir) {
         printf("<This branch (L14210) is removed by Cov debloating tool>\n"); exit(6);
      } else {
        tmp___52 = "/tmp";
      }
    ...
    if (nfiles == 0UL) {
       ...
       printf("<This branch (L14219) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (0UL < sort_size) {
       ...
       printf("<This branch (L14226) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (checkonly) {
       ...
       printf("<This branch (L14244) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (mergeonly) {
    ...
    while_break___5:;
       printf("<This branch (L14258) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      if (!nthreads) {
        ...
        if (np < 8UL) {
          nthreads = np;
           ...
           printf("<This branch (L14266) is removed by Cov debloating tool>\n"); exit(6);
        }
      }
      ...
      if (nthreads < nthreads_max) {
        nthreads = nthreads;
         ...
         printf("<This branch (L14273) is removed by Cov debloating tool>\n"); exit(6);
      }
    ...
    if (have_read_stdin) {
       ...
       printf("<This branch (L14282) is removed by Cov debloating tool>\n"); exit(6);
    }
    exit(0);
  }
}

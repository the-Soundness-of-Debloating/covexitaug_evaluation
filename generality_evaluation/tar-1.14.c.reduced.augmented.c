...
void xclose(int fd) {
  ...
  char *__cil_tmp4;
  {
    ...
    if (tmp___0 != 0) {
      ...
      } printf("<This branch (L998) is removed by Cov debloating tool>\n"); exit(6);
    }
    return;
  }
}
...
void archive_write_error(ssize_t status) {
   ...
   printf("<This branch (L1798) is removed by Cov debloating tool>\n"); exit(6);
}
void archive_read_error(void) {
...
void fatal_exit(void) {
   ...
   printf("<This branch (L8902) is removed by Cov debloating tool>\n"); exit(6);
}
...
static void xheader_set_single_keyword(char *kw) {
   ...
   printf("<This branch (L9057) is removed by Cov debloating tool>\n"); exit(6);
}
...
void skip_file(off_t size) {
  ...
  char *__cil_tmp4;
  {
    if (multi_volume_option) {
       ...
       printf("<This branch (L13945) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
      while (1) {
      while_continue: /* CIL Label */;
        ...
        if (!x) {
          ...
          } printf("<This branch (L13959) is removed by Cov debloating tool>\n"); exit(6);
        }
        {
        ...
        if (multi_volume_option) {
           printf("<This branch (L13966) is removed by Cov debloating tool>\n"); exit(6);
        }
      }
    while_break: /* CIL Label */;
    }
...
static void call_arg_fatal(char const *call, char const *name) {
   ...
   printf("<This branch (L15248) is removed by Cov debloating tool>\n"); exit(6);
}
...
void chdir_fatal(char const *name) {
   ...
   printf("<This branch (L15272) is removed by Cov debloating tool>\n"); exit(6);
}
void chmod_error_details(char const *name, mode_t mode) {
...
void exec_fatal(char const *name) {
   ...
   printf("<This branch (L15345) is removed by Cov debloating tool>\n"); exit(6);
}
void link_error(char const *target, char const *source) {
...
void open_fatal(char const *name) {
   ...
   printf("<This branch (L15400) is removed by Cov debloating tool>\n"); exit(6);
}
void open_warn(char const *name) {
...
void read_fatal(char const *name) {
   ...
   printf("<This branch (L15493) is removed by Cov debloating tool>\n"); exit(6);
}
__attribute__((__noreturn__)) void
read_fatal_details(char const *name, off_t offset, size_t size);
void read_fatal_details(char const *name, off_t offset, size_t size) {
   ...
   printf("<This branch (L15518) is removed by Cov debloating tool>\n"); exit(6);
}
void readlink_error(char const *name) {
...
pid_t xfork(void) {
  ...
  char *__cil_tmp5;
  {
    ...
    if (p == -1) {
      ...
      } printf("<This branch (L15776) is removed by Cov debloating tool>\n"); exit(6);
    }
    return (p);
  }
}
void xpipe(int *fd) {
  ...
  char *__cil_tmp5;
  {
    ...
    if (tmp___0 < 0) {
      ...
      } printf("<This branch (L15792) is removed by Cov debloating tool>\n"); exit(6);
    }
    return;
  }
}
    ...
    if (tmp___0 != 0) {
      if (!force_local_option) {
        ...
        if (rmt_path__) {
           ...
           printf("<This branch (L20478) is removed by Cov debloating tool>\n"); exit(6);
        } else {
          goto _L___1;
        }
      } else {
      _L___1 : { tmp___2 = is_regular_file(*(archive_name_array + 0)); }
        if (tmp___2) {
          ...
          if (archive < 0) {
            ...
            } printf("<This branch (L20493) is removed by Cov debloating tool>\n"); exit(6);
          }
          {
            xdup2(archive, 0);
            execlp(use_compress_program_option, use_compress_program_option,
...
void request_stdin(char const *option) {
  ...
  char *__cil_tmp3;
  {
    if (stdin_used_by) {
      ...
      } printf("<This branch (L20715) is removed by Cov debloating tool>\n"); exit(6);
    }
...
void usage(int status) {
  ...
  char *__cil_tmp38;
  {
    if (status != 0) {
      ...
      } printf("<This branch (L21232) is removed by Cov debloating tool>\n"); exit(6);
    }
    { exit(status); }
  }
}
    ...
    if (use_compress_program_option) {
      {
       ...
       printf("<This branch (L21269) is removed by Cov debloating tool>\n"); exit(6);
    }
...
int add_exclude_file(void (*add_func)(struct exclude *, char const *, int),
  ...
  int tmp___11;
  {
    if ((int const) * (filename + 0) == 45) {
       ...
       printf("<This branch (L24186) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      tmp___9 = 0;
    }
    ...
    e = 0;
    if (use_stdin) {
       printf("<This branch (L24196) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      {
      ...
      if (!in) {
         printf("<This branch (L24203) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
    {
      while (1) {
    ...
    if (tmp___2) {
      ...
      } printf("<This branch (L24230) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (!use_stdin) {
      {
        tmp___4 = fclose(in);
    ...
    if (buf_count == 0UL) {
       printf("<This branch (L24249) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      if ((int)*(buf + (buf_count - 1UL)) == (int)line_end) {
        tmp___10 = 0;
      } else {
         printf("<This branch (L24254) is removed by Cov debloating tool>\n"); exit(6);
      }
    }
          ...
          if (tmp___7) {
            {
              ...
              while_continue___1: /* CIL Label */;
                if ((unsigned long)pattern_end == (unsigned long)pattern) {
                   printf("<This branch (L24276) is removed by Cov debloating tool>\n"); exit(6);
                } else {
    ...
    if (e) {
       printf("<This branch (L24304) is removed by Cov debloating tool>\n"); exit(6);
    } else {
      tmp___11 = 0;
    }
    return (tmp___11);
  ...
  struct quoting_options *tmp;
  {
    ...
    if (o___0) {
      tmp = o___0;
       ...
       printf("<This branch (L28479) is removed by Cov debloating tool>\n"); exit(6);
    }
  ...
  char *__cil_tmp39;
  {
    ...
    }
    {
      if ((unsigned int)quoting_style == 3U) {
         printf("<This branch (L28553) is removed by Cov debloating tool>\n"); exit(6);
      }
      if ((unsigned int)quoting_style == 4U) {
        goto case_4;
      }
       printf("<This branch (L28558) is removed by Cov debloating tool>\n"); exit(6);
      ...
      while_continue___3: /* CIL Label */;
        if (argsize == 0xffffffffffffffffUL) {
          tmp___9 = (int const) * (arg + i) == 0;
           ...
           printf("<This branch (L28649) is removed by Cov debloating tool>\n"); exit(6);
        }
        if (tmp___9) {
          goto while_break___3;
        }
        if (backslash_escapes) {
          if (quote_string_len) {
             ...
             printf("<This branch (L28674) is removed by Cov debloating tool>\n"); exit(6);
          }
        }
        c = (unsigned char)*(arg + i);
        {
          if ((int)c == 0) {
             printf("<This branch (L28680) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 63) {
             printf("<This branch (L28683) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 7) {
             printf("<This branch (L28686) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 8) {
             printf("<This branch (L28689) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 12) {
             printf("<This branch (L28692) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 10) {
             printf("<This branch (L28695) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 13) {
             printf("<This branch (L28698) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 9) {
             printf("<This branch (L28701) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 11) {
             printf("<This branch (L28704) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 92) {
             printf("<This branch (L28707) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 123) {
             printf("<This branch (L28710) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 125) {
             printf("<This branch (L28713) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 35) {
             printf("<This branch (L28716) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 126) {
             printf("<This branch (L28719) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 32) {
             printf("<This branch (L28722) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 33) {
             printf("<This branch (L28725) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 34) {
             printf("<This branch (L28728) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 36) {
             printf("<This branch (L28731) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 38) {
             printf("<This branch (L28734) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 40) {
             printf("<This branch (L28737) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 41) {
             printf("<This branch (L28740) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 42) {
             printf("<This branch (L28743) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 59) {
             printf("<This branch (L28746) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 60) {
             printf("<This branch (L28749) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 61) {
             printf("<This branch (L28752) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 62) {
             printf("<This branch (L28755) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 91) {
             printf("<This branch (L28758) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 94) {
             printf("<This branch (L28761) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 96) {
             printf("<This branch (L28764) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 124) {
             printf("<This branch (L28767) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 39) {
             printf("<This branch (L28770) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 37) {
             printf("<This branch (L28773) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 43) {
             printf("<This branch (L28776) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 44) {
             printf("<This branch (L28779) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 45) {
             printf("<This branch (L28782) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 46) {
             printf("<This branch (L28785) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 47) {
             printf("<This branch (L28788) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 48) {
             printf("<This branch (L28791) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 49) {
             printf("<This branch (L28794) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 50) {
             printf("<This branch (L28797) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 51) {
             printf("<This branch (L28800) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 52) {
             printf("<This branch (L28803) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 53) {
             printf("<This branch (L28806) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 54) {
             printf("<This branch (L28809) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 55) {
             printf("<This branch (L28812) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 56) {
             printf("<This branch (L28815) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 57) {
             printf("<This branch (L28818) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 58) {
             printf("<This branch (L28821) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 65) {
             printf("<This branch (L28824) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 66) {
             printf("<This branch (L28827) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 67) {
             printf("<This branch (L28830) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 68) {
             printf("<This branch (L28833) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 69) {
             printf("<This branch (L28836) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 70) {
             printf("<This branch (L28839) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 71) {
             printf("<This branch (L28842) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 72) {
             printf("<This branch (L28845) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 73) {
             printf("<This branch (L28848) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 74) {
             printf("<This branch (L28851) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 75) {
             printf("<This branch (L28854) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 76) {
             printf("<This branch (L28857) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 77) {
             printf("<This branch (L28860) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 78) {
             printf("<This branch (L28863) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 79) {
             printf("<This branch (L28866) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 80) {
             printf("<This branch (L28869) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 81) {
             printf("<This branch (L28872) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 82) {
             printf("<This branch (L28875) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 83) {
             printf("<This branch (L28878) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 84) {
             printf("<This branch (L28881) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 85) {
             printf("<This branch (L28884) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 86) {
             printf("<This branch (L28887) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 87) {
             printf("<This branch (L28890) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 88) {
             printf("<This branch (L28893) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 89) {
             printf("<This branch (L28896) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 90) {
             printf("<This branch (L28899) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 93) {
             printf("<This branch (L28902) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 95) {
             printf("<This branch (L28905) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 97) {
            goto case_37;
          }
          ...
          if ((int)c == 99) {
             printf("<This branch (L28914) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 100) {
             printf("<This branch (L28917) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 101) {
             printf("<This branch (L28920) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 102) {
             printf("<This branch (L28923) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 103) {
             printf("<This branch (L28926) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 104) {
             printf("<This branch (L28929) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 105) {
             printf("<This branch (L28932) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 106) {
             printf("<This branch (L28935) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 107) {
             printf("<This branch (L28938) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 108) {
             printf("<This branch (L28941) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 109) {
             printf("<This branch (L28944) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 110) {
             printf("<This branch (L28947) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 111) {
             printf("<This branch (L28950) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 112) {
             printf("<This branch (L28953) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 113) {
             printf("<This branch (L28956) is removed by Cov debloating tool>\n"); exit(6);
          }
          if ((int)c == 114) {
            goto case_37;
          }
           printf("<This branch (L28961) is removed by Cov debloating tool>\n"); exit(6);
        ...
        if (backslash_escapes) {
          if (!(o___0->quote_these_too[(unsigned long)c / (sizeof(int) * 8UL)] &
           ...
           printf("<This branch (L29502) is removed by Cov debloating tool>\n"); exit(6);
        }
       printf("<This branch (L29504) is removed by Cov debloating tool>\n"); exit(6);
    ...
    if (i == 0UL) {
       ...
       printf("<This branch (L29533) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (quote_string) {
      {
      ...
      } printf("<This branch (L29556) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (len < buffersize) {
  ...
  int *tmp___1;
  {
    if (o___0) {
      p = o___0;
       ...
       printf("<This branch (L29581) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
      tmp = __errno_location();
      e = *tmp;
...
static char *quotearg_n_options(int n, char const *arg, size_t argsize,
  ...
  int tmp___5;
  {
    ...
    if (n < 0) {
      ...
      } printf("<This branch (L29625) is removed by Cov debloating tool>\n"); exit(6);
    }
    if (nslots <= n0) {
      ...
      } printf("<This branch (L29653) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
      size = (slotvec + n)->size;
      val = (slotvec + n)->val;
    ...
    if (size <= qsize) {
      ...
      } printf("<This branch (L29674) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
      tmp___4 = __errno_location();
      *tmp___4 = e;
...
void xalloc_die(void) {
   ...
   printf("<This branch (L30040) is removed by Cov debloating tool>\n"); exit(6);
}
  ...
  void *tmp;
  {
    ...
    if (!p) {
      if (!n) {
       ...
       printf("<This branch (L30119) is removed by Cov debloating tool>\n"); exit(6);
    }
    {
      *pn = n;
      tmp = xrealloc(p, n * s);
